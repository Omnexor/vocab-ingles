...
export const LESSONS = [
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["","Estructura","Ejemplo","En español"],
        rows: [
          ["Afirmativa","Sujeto + verbo","She works here.","Ella trabaja aquí."],
          ["Negativa","Sujeto + auxiliar + not + verbo","She does not work here.","Ella no trabaja aquí."],
          ["Pregunta","Auxiliar + sujeto + verbo","Does she work here?","¿Trabaja ella aquí?"]
        ],
      },
      {
        t: "examples",
        items: [
          ...
          { en: "It's raining again.", pron: "its réi-ning a-guén", es: "Está lloviendo otra vez." },
          { en: "She doesn't live here.", pron: "shi dá-sent liv jier", es: "Ella no vive aquí." },
          { en: "Do you speak English?", pron: "du yu spiik ín-glish", es: "¿Hablas inglés?" }
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["","Forma","Ejemplo","En español"],
        rows: [
          ["I / you / we / they","verbo base","I work from home.","Trabajo desde casa."],
          ["he / she / it","verbo + -s","He works from home.","Él trabaja desde casa."],
          ["Negativa","don't / doesn't + base","She doesn't work on Fridays.","Ella no trabaja los viernes."],
          ["Pregunta","Do / Does + sujeto + base","Do you work here?","¿Trabajas aquí?"]
        ],
      },
      {
        t: "p",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "He works in a bank.", pron: "ji uérks in a bank", es: "Trabaja en un banco." },
          { en: "We don't watch TV.", pron: "ui dóunt uoch tii-víi", es: "No vemos la tele." },
          { en: "Does she live near you?", pron: "das shi liv nier yu", es: "¿Vive cerca de ti?" }
        ],
      },
      {
        t: "p",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Hay un uso que sorprende y que conviene tener claro: el presente continuo también sirve para el FUTURO, cuando el plan ya está cerrado. «I'm meeting Ana at six» no es que la estés viendo ahora — es que habéis quedado. El español hace lo mismo con el presente («mañana ceno con Ana»), así que la idea ya la tienes; lo único distinto es que el inglés usa la forma continua en vez del presente simple.",
      },
      {
        t: "p",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I'm reading a great book.", pron: "aim ríi-ding a gréit buk", es: "Estoy leyendo un libro buenísimo." },
          { en: "We're meeting Ana at six.", pron: "uir míi-ting á-na at siks", es: "Hemos quedado con Ana a las seis." },
          { en: "Why are you laughing?", pron: "uái ar yu lá-fing", es: "¿De qué te ríes?" }
        ],
      }
    ],
    quiz: [
...

  {
    ...
    blocks: [
      ...
      },
      {
        ...
        head: ["","Estructura","Ejemplo","En español"],
        rows: [
          ["Afirmativa (regular)","verbo + -ed","I worked late yesterday.","Ayer trabajé hasta tarde."],
          ["Afirmativa (irregular)","forma propia","I went to Paris.","Fui a París."],
          ["Negativa","didn't + base","I didn't go to Paris.","No fui a París."],
          ["Pregunta","Did + sujeto + base","Did you go to Paris?","¿Fuiste a París?"]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "We went to the beach.", pron: "ui uent tu de biich", es: "Fuimos a la playa." },
          { en: "She didn't say anything.", pron: "shi dí-dent séi é-ni-zing", es: "No dijo nada." },
          { en: "Did you like the movie?", pron: "did yu láik de múu-vi", es: "¿Te gustó la película?" }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Sirve sobre todo para poner el DECORADO de una historia: lo que ya estaba en marcha cuando pasó lo importante. Por eso casi nunca va solo — aparece emparejado con un pasado simple que lo interrumpe. Si cuentas algo y quieres situar la escena antes del golpe, esa parte va en continuo.",
      },
      {
        t: "error",
        wrong: "I was knowing the answer. / While I cooked, the phone rang.",
        right: "I knew the answer. / While I was cooking, the phone rang.",
        why: "Los verbos de estado (know, want, like) no van nunca en continuo. Y con «while» lo normal es el continuo: la acción larga es la que dura, y la corta que la interrumpe va en pasado simple.",
      },
      {
        t: "examples",
        items: [
          ...
          { en: "I was cooking when you called.", pron: "ai uós kú-king uén yu kold", es: "Estaba cocinando cuando llamaste." },
          { en: "They were sleeping at midnight.", pron: "déi uér slíi-ping at mid-náit", es: "Estaban durmiendo a medianoche." },
          { en: "What was she doing there?", pron: "uót uós shi dú-ing der", es: "¿Qué estaba haciendo ella allí?" }
        ],
      },
      {
        t: "tip",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { en: "Look at those clouds. It's going to rain.", pron: "luk at dóus cláuds. its gó-ing tu réin", es: "Mira esas nubes. Va a llover." },
          { en: "We're flying to Lisbon on Monday.", pron: "uír flái-ing tu lís-bon on mán-dei", es: "Volamos a Lisboa el lunes." },
          { en: "I'll help you with that.", pron: "ail jelp yu uid dat", es: "Te ayudo con eso." },
          { en: "She's going to start a business.", pron: "shis gó-ing tu start a bís-nes", es: "Va a montar un negocio." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Irregular","Comparativo","Superlativo","En español"],
        rows: [
          ["good","better","the best","bueno → mejor → el mejor"],
          ["bad","worse","the worst","malo → peor → el peor"],
          ["far","further / farther","the furthest / farthest","lejos → más lejos → el más lejano"],
          ["little","less","the least","poco → menos → el mínimo"],
          ["much / many","more","the most","mucho → más → el máximo"]
        ],
      },
      {
        t: "formula",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "El plural inglés es casi todo -s, y ahí no hay problema. El lío viene por dos sitios. Primero, un puñado de plurales irregulares que hay que saberse sueltos (man/men, child/children, foot/feet). Y segundo, y más importante, las palabras que directamente NO tienen plural en inglés aunque en español sí: information, advice, furniture, luggage, money. Decir «informations» es de los errores que más se repiten, y viene de calcar el plural español.",
      },
      {
        t: "error",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "The children are playing.", pron: "de chíl-dren ar pléi-ing", es: "Los niños están jugando." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La regla es de una sola línea y resuelve todos los casos: las PERSONAS sienten (-ed) y las COSAS provocan (-ing). Un examen es «boring» porque provoca aburrimiento; tú estás «bored» porque lo sientes. Por eso «I am boring» no es un error pequeño: estás diciendo que la persona aburrida eres tú, no que te aburras.",
      },
      {
        t: "p",
        text: "Truco de traducción para decidir rápido: si en español dirías «estoy…», va -ed. Si dirías «es…», va -ing. «Estoy cansado» → I'm tired. «Es cansado» (el viaje) → it's tiring.",
      },
      {
        t: "formula",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Esto no va de memorizar listas: va de multiplicar lo que ya sabes. Si conoces «happy», con los prefijos y sufijos tienes gratis unhappy, happily, happiness y unhappily. Reconocer las piezas te permite entender palabras que nunca has estudiado, que es exactamente lo que necesitas al leer o al escuchar algo por encima de tu nivel.",
      },
      {
        t: "p",
        text: "Los prefijos cambian el SIGNIFICADO (un- niega, re- repite, mis- estropea) y los sufijos cambian la CLASE de palabra (-ly hace adverbios, -ness hace sustantivos, -ful y -less hacen adjetivos). Con esa división ya sabes qué esperar de una palabra larga aunque no la hayas visto nunca.",
      },
      {
        t: "table",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "El orden largo (opinión, tamaño, edad, color, material) parece imposible de memorizar, y la buena noticia es que casi nunca hace falta: en la vida real rara vez se encadenan más de dos adjetivos. Lo que sí conviene tener automatizado es lo de siempre — que van DELANTE del sustantivo y que no cambian nunca de forma.",
      },
      {
        t: "p",
        text: "Si algún día te salen tres, la regla práctica es que la opinión va primero (nice, beautiful, horrible) y el material va último (wooden, leather, plastic). Lo demás casi nunca se nota.",
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Solo hace falta cuando cuentas dos cosas del pasado y quieres dejar claro cuál ocurrió ANTES. Si el orden ya se entiende por el contexto o porque las cuentas en orden, el pasado simple basta y es lo que se usa. Por eso el past perfect aparece mucho menos de lo que parece cuando lo estudias.",
      },
      {
        t: "p",
        text: "En español es exactamente el mismo tiempo: «había llegado». Si en tu cabeza suena «había + participio», en inglés es «had + participio». La forma no es el problema; el problema es acordarse de usarlo cuando el orden importa.",
      },
      {
        t: "formula",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La diferencia con el present perfect normal está en dónde pones el foco. «I've read that book» destaca el RESULTADO: ya lo leí. «I've been reading that book» destaca la ACTIVIDAD y su duración: llevo un rato con él, quizá sin terminarlo.",
      },
      {
        t: "p",
        text: "Por eso este tiempo es el que traduce «llevo + tiempo + gerundio», que en español usamos constantemente. «Llevo dos horas esperando» es «I've been waiting for two hours» — nunca «I am waiting for two hours», que es el error más frecuente con esta estructura.",
      },
      {
        t: "formula",
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Tiempo","Activa","Pasiva","La pasiva en español"],
        rows: [
          ["Presente simple","They clean the office every day.","The office is cleaned every day.","La oficina se limpia todos los días."],
          ["Pasado simple","Someone stole my bike.","My bike was stolen.","Me robaron la bici."],
          ["Present perfect","They have canceled the flight.","The flight has been canceled.","Han cancelado el vuelo."],
          ["Futuro (will)","They will announce the results.","The results will be announced.","Se anunciarán los resultados."]
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La idea de fondo es que todo retrocede un paso: si lo que se dijo estaba en presente, pasa a pasado; si estaba en pasado, pasa a past perfect. Los modales hacen lo mismo (will→would, can→could), y ahí vuelve a aparecer el -ía español: «dijo que vendría».",
      },
      {
        t: "p",
        text: "También se mueven las palabras que dependen de dónde y cuándo estás: today→that day, tomorrow→the next day, here→there, this→that. Tiene lógica: si repites mañana lo que alguien dijo hoy, «hoy» ya no es hoy.",
      },
      {
        t: "formula",
      ...
      {
        t: "table",
        head: ["Dijo (estilo directo)","Cuentas (estilo indirecto)","En español"],
        rows: [
          ["\"I am tired.\"","She said she was tired.","Dijo que estaba cansada."],
          ["\"I work here.\"","He said he worked there.","Dijo que trabajaba allí."],
          ["\"I have finished.\"","She said she had finished.","Dijo que había terminado."],
          ["\"I will call you.\"","He said he would call me.","Dijo que me llamaría."],
          ["\"I can help.\"","She said she could help.","Dijo que podía ayudar."]
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Verbo + -ing","Ejemplo","En español"],
        rows: [
          ["enjoy","I enjoy reading.","disfrutar — Disfruto leyendo."],
          ["finish","She finished working at six.","terminar — Terminó de trabajar a las seis."],
          ["avoid","We avoided talking about it.","evitar — Evitamos hablar de ello."],
          ["suggest","He suggested going by train.","sugerir — Sugirió ir en tren."],
          ["mind","Do you mind waiting?","importar — ¿Te importa esperar?"]
        ],
      },
      {
        t: "table",
        head: ["Verbo + to + infinitivo","Ejemplo","En español"],
        rows: [
          ["want","I want to travel.","querer — Quiero viajar."],
          ["decide","They decided to leave.","decidir — Decidieron irse."],
          ["hope","She hopes to pass the exam.","esperar — Espera aprobar el examen."],
          ["promise","I promise to call you.","prometer — Prometo llamarte."],
          ["need","We need to talk.","necesitar — Tenemos que hablar."]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I'm looking forward to seeing you.", pron: "aim lú-king fór-uard tu sí-ing yu", es: "Tengo ganas de verte." }
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Sirven para meter información extra sin abrir una frase nueva. En español usamos «que» para casi todo, y el inglés reparte según de qué hables: WHO para personas, WHICH para cosas y THAT para las dos. Si dudas, «that» casi siempre encaja.",
      },
      {
        t: "p",
        text: "Hay un detalle que se agradece saber: cuando el relativo es el OBJETO de la frase, se puede quitar. «The book that I bought» y «The book I bought» son las dos correctas, y la segunda es la que más se oye. En español eso no se puede hacer nunca.",
      },
      {
        t: "table",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Los dos sirven para hábitos del pasado, pero no son intercambiables del todo: «used to» vale para hábitos Y para estados («I used to live in Madrid»), mientras que «would» solo vale para acciones repetidas. No se puede decir «I would live in Madrid» con ese sentido.",
      },
      {
        t: "p",
        text: "Por eso, si dudas, «used to» siempre es seguro. «Would» se usa sobre todo cuando ya has situado la época y estás contando cómo era aquello: «Every summer we would go to the beach».",
      },
      {
        t: "formula",
      ...
      },
      {
        ...
        head: ["","Estructura","Ejemplo","En español"],
        rows: [
          ["Afirmativa","used to + base","She used to smoke.","Antes fumaba."],
          ["Negativa","didn't use to + base","She didn't use to smoke.","Antes no fumaba."],
          ["Pregunta","Did…use to + base","Did she use to smoke?","¿Antes fumaba?"]
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Todo depende de una pregunta previa: ¿la palabra se puede contar? Si puedes decir «one, two, three» delante, es contable y va con many, few y a few. Si necesitas una medida, es incontable y va con much, little y a little.",
      },
      {
        t: "p",
        text: "Y ojo con la pareja que cambia el tono: «a few» y «a little» son positivos («tengo unos cuantos»), mientras que «few» y «little» a secas son negativos («tengo pocos, casi ninguno»). Ese artículo diminuto cambia por completo lo que transmites.",
      },
      {
        t: "table",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La mecánica es siempre la misma: se repite el auxiliar de la frase y se le da la vuelta al signo. Frase afirmativa, coletilla negativa; frase negativa, coletilla afirmativa. Si la frase no tiene auxiliar, se trae «do», «does» o «did», exactamente igual que en las preguntas normales.",
      },
      {
        t: "p",
        text: "En la conversación real casi nunca preguntan de verdad: sirven para buscar acuerdo, dar pie a que el otro hable o suavizar una afirmación. Por eso se dicen con entonación descendente, no de pregunta.",
      },
      {
        t: "formula",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { en: "There's a problem with the car.", pron: "ders a pró-blem uid de kar", es: "Hay un problema con el coche." },
          { en: "There are three people waiting.", pron: "der ar zrii píi-pol uéi-ting", es: "Hay tres personas esperando." },
          { en: "Is there a bathroom here?", pron: "is der a báz-ruum jier", es: "¿Hay un baño aquí?" }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La regla es puramente mecánica y por eso es fácil de automatizar: si detrás va la persona a quien hablas, es TELL. Si no va, es SAY. «Tell me», «tell him», «tell us» — pero «say something», «say that», «say hello».",
      },
      {
        t: "p",
        text: "«Speak» y «talk» son otra cosa: no son «decir», son «hablar». Speak se usa para idiomas y para situaciones más formales; talk es conversar con alguien. «I speak English» pero «we talked for an hour».",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "Tell me what happened.", pron: "tel mi uót já-pend", es: "Cuéntame qué pasó." },
          { en: "She said she was busy.", pron: "shi sed shi uós bí-si", es: "Dijo que estaba ocupada." },
          { en: "We talked for an hour.", pron: "ui tokt for an áu-er", es: "Estuvimos hablando una hora." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La idea que los separa: MAKE es crear algo que antes no existía (una tarta, una decisión, un ruido), y DO es realizar una actividad o una tarea (los deberes, los platos, ejercicio). No es infalible, pero acierta en la mayoría de los casos.",
      },
      {
        t: "p",
        text: "Lo demás son combinaciones fijas que se aprenden como bloques: make a mistake, make money, make friends, do your best, do the shopping, do business. Cuando una expresión no encaja en la idea general, es que es una de estas.",
      },
      {
        t: "table",
        head: ["MAKE (crear, producir)","DO (actividad, tarea)","En español"],
        rows: [
          ["make a mistake","do your homework","cometer un error"],
          ["make a decision","do the shopping","tomar una decisión"],
          ["make a noise","do the dishes","hacer ruido"],
          ["make money","do exercise","ganar dinero"],
          ["make a plan","do business","hacer un plan"],
          ["make friends","do a favor","hacer amigos"],
          ["make dinner","do your best","hacer la cena"],
          ["make an effort","do nothing","hacer un esfuerzo"]
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Las tres se traducen con «desde» o «hace», y lo que las separa es qué tipo de dato les sigue. FOR va con una duración (for two years, for a while). SINCE va con un punto de inicio (since 2019, since Monday). Y AGO va detrás de la cantidad y mira desde hoy hacia atrás (two years ago).",
      },
      {
        t: "p",
        text: "El detalle que más se falla: «ago» pide pasado simple y nunca present perfect. «I have seen him two hours ago» está mal; es «I saw him two hours ago». Si dices cuándo, es pasado simple.",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I've lived here for ten years.", pron: "aiv livd jier for ten yiers", es: "Llevo diez años viviendo aquí." },
          { en: "She's been here since Monday.", pron: "shis bin jier sins mán-dei", es: "Está aquí desde el lunes." },
          { en: "They left two hours ago.", pron: "déi left tuu áu-ers a-góu", es: "Se fueron hace dos horas." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La regla básica es corta: SOME en afirmativas, ANY en negativas y preguntas. Y hay una excepción muy usada que conviene tener a mano: en los ofrecimientos y las peticiones se usa «some» aunque sean preguntas, porque das por hecho la respuesta. «Would you like some coffee?» suena mucho mejor que «any coffee».",
      },
      {
        t: "p",
        text: "Lo que más cuesta al principio no es elegir entre las dos, sino acordarse de poner alguna. En español muchas frases van sin nada delante («quiero agua», «¿tienes hermanos?») y en inglés casi siempre hay que poner algo.",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I need some help.", pron: "ai niid sam jelp", es: "Necesito ayuda." },
          { en: "Do you have any questions?", pron: "du yu jav é-ni kués-chons", es: "¿Tienes alguna pregunta?" },
          { en: "Would you like some water?", pron: "uúd yu láik sam uó-rer", es: "¿Quieres un poco de agua?" }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "No hay reglas: la preposición que lleva cada verbo es una decisión histórica de cada idioma, y no coinciden. Por eso la única estrategia que funciona es aprenderse el verbo y su preposición como una sola palabra, igual que aprendes «depend on» de un tirón, sin separarlo.",
      },
      {
        t: "p",
        text: "Los que más fallan los hispanohablantes son justo los que en español llevan preposición distinta o no llevan ninguna: depend ON (de), think ABOUT (en), listen TO (sin nada en español), look FOR (sin nada), wait FOR (a), arrive IN/AT (a, y nunca «to»).",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "It depends on the weather.", pron: "it di-pénds on de ué-der", es: "Depende del tiempo." },
          { en: "I'm looking for my keys.", pron: "aim lú-king for mai kiis", es: "Estoy buscando mis llaves." },
          { en: "She's waiting for the bus.", pron: "shis uéi-ting for de bas", es: "Está esperando el autobús." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "El apóstrofo funciona al revés que el español: primero el dueño, luego la cosa. «El coche de mi hermano» se monta como «my brother's car». Al principio hay que darle la vuelta a la frase mentalmente, pero se automatiza rápido porque sale constantemente.",
      },
      {
        t: "p",
        text: "Con cosas, en cambio, se prefiere «of»: «the end of the street», no «the street's end». La regla práctica es que el apóstrofo es para seres vivos —personas, animales— y para expresiones de tiempo (today's news, a week's vacation).",
      },
      {
        t: "formula",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "This is my sister's car.", pron: "dis is mai sís-ters kar", es: "Este es el coche de mi hermana." },
          { en: "The children's room is upstairs.", pron: "de chíl-drens ruum is aps-térs", es: "La habitación de los niños está arriba." },
          { en: "Have you seen today's news?", pron: "jav yu siin tu-déis niús", es: "¿Has visto las noticias de hoy?" }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Un phrasal verb es un verbo con una partícula que juntos significan otra cosa: «look» es mirar, pero «look after» es cuidar. Son de lo más frecuente del inglés hablado y de lo que más separa el inglés de libro del inglés real.",
      },
      {
        t: "p",
        text: "Lo que más se falla no es el significado, sino dónde colocar el objeto. Y ahí solo hay una regla que memorizar: si el objeto es un pronombre (it, them, him), va SIEMPRE en medio. «Turn it off», nunca «turn off it».",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "She looks after her mother.", pron: "shi luks áf-ter jer má-der", es: "Cuida de su madre." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La -ed del pasado tiene tres sonidos y ninguno es «ed» tal como lo lee un español. Y no hay que elegir: el sonido sale solo según lo que va antes, igual que la -s del plural. Es el mismo mecanismo, así que aprender una te da la otra gratis.",
      },
      {
        t: "p",
        text: "El caso que cambia las cosas es el tercero: tras t o d, la -ed suena como una sílaba entera. «Want» tiene una sílaba y «wanted» tiene dos. Decir «uór-ked» en vez de «uerkt» es el error que más delata, porque añade sílabas que el nativo no espera.",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I worked late yesterday.", pron: "ai uerkt léit yés-ter-dei", es: "Ayer trabajé hasta tarde." },
          { en: "She wanted to help.", pron: "shi uón-ted tu jelp", es: "Quería ayudar." },
          { en: "They played all afternoon.", pron: "déi pléid ol af-ter-núun", es: "Jugaron toda la tarde." }
        ],
      },
      {
        t: "error",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I need more information.", pron: "ai niid mor in-for-méi-shon", es: "Necesito más información." },
          { en: "The hotel is over there.", pron: "de jou-tél is óu-ver der", es: "El hotel está allí." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Las tres suenan exactamente igual, así que al hablar no hay problema — el lío es solo al escribir, y al leer, cuando tienes que decidir qué significa la que ves.",
      },
      {
        t: "p",
        text: "La forma más rápida de distinguirlas es probar a sustituir. Si puedes cambiarla por «they are», es THEY'RE. Si detrás hay un sustantivo y significa «su», es THEIR. Y si no es ninguna de las dos, es THERE, que sirve para «allí» y para «hay».",
      },
      {
        t: "table",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "They're waiting outside.", pron: "der uéi-ting aut-sáid", es: "Están esperando fuera." },
          { en: "There are two of them.", pron: "der ar tuu ov dem", es: "Hay dos." }
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Todo el sistema verbal inglés se monta con dos auxiliares y cinco formas del verbo. BE + -ing hace los tiempos continuos (lo que está pasando). HAVE + participio hace los perfectos (lo que ya ha pasado y conecta con ahora). Y si juntas los dos, sale «have been + -ing».",
      },
      {
        t: "p",
        text: "Visto así, no hay doce tiempos que memorizar: hay dos piezas que se combinan. Cuando dudes de cómo se forma algo, pregúntate si quieres continuo (be + -ing), perfecto (have + participio) o los dos a la vez.",
      },
      {
        t: "table",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { en: "That was a tough day.", pron: "dat uós a taf déi", es: "Fue un día duro." },
          { en: "I thought you knew.", pron: "ai zot yu niú", es: "Pensaba que lo sabías." },
          { en: "We walked through the park.", pron: "ui uokt zruu de park", es: "Cruzamos el parque." }
        ],
      },
      {
        t: "p",
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Grupo","Verbos","Ejemplo","En español"],
        rows: [
          ["Cabeza","know, think (opinar), believe, remember, forget, understand, mean","I know the answer.","Sé la respuesta."],
          ["Gustos","like, love, hate, prefer, want, need","I want a coffee.","Quiero un café."],
          ["Sentidos","see, hear, smell, taste, seem, look (parecer)","It smells good.","Huele bien."],
          ["Tener y ser","be, have (poseer), own, belong, cost","This costs ten dollars.","Esto cuesta diez dólares."]
        ],
      },
      {
        t: "error",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "I don't understand this.", pron: "ai dount an-ders-tand dis", es: "No entiendo esto." },
          { en: "She has two brothers.", pron: "shi jas tu brá-ders", es: "Tiene dos hermanos." },
          { en: "I'm having dinner right now.", pron: "aim já-ving dí-ner ráit náu", es: "Estoy cenando ahora mismo." },
          { en: "I know what you mean.", pron: "ai nóu uót yu miin", es: "Sé lo que quieres decir." },
          { en: "This soup tastes great.", pron: "dis suup téists gréit", es: "Esta sopa está buenísima." },
          { en: "Do you understand me?", pron: "du yu an-ders-tánd mi", es: "¿Me entiendes?" }
        ],
      }
    ],
    quiz: [
      ...
      { q: "«Esto huele bien» es…", options: ["This is smelling good","This smells good","This smell good"], answer: 1, why: "Los sentidos van en presente simple: smells." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "La regla es de una sola línea: dentro de otra frase, la pregunta pierde la inversión y vuelve al orden normal de sujeto + verbo. «Where is the bank?» es una pregunta suelta y lleva el verbo delante; en cuanto la metes dentro de otra («Do you know where the bank IS?»), el verbo vuelve a su sitio detrás del sujeto.",
      },
      {
        t: "p",
        text: "A un español le sale mal porque nosotros SÍ invertimos en los dos casos: decimos «¿dónde está el banco?» y también «¿sabes dónde está el banco?». Copiamos ese orden y sale «Do you know where is the bank?», que es de los errores que más se oyen. Y desaparece también el «do»: dentro de la frase no hace falta, porque ya hay un auxiliar al principio.",
      },
      {
        t: "formula",
      ...
      {
        t: "table",
        head: ["Pregunta suelta","Dentro de otra frase"],
        rows: [
          ["Where is the station?","Do you know where the station is?"],
          ["What time does it open?","Can you tell me what time it opens?"],
      ...
      },
      {
        t: "examples",
        items: [
          { en: "Could you tell me where the exit is?", pron: "kud yu tel mi uer di ék-sit is", es: "¿Me puede decir dónde está la salida?" },
          { en: "I don't know what he wants.", pron: "ai dount nóu uót ji uónts", es: "No sé qué quiere." },
          { en: "Do you know if the store is open?", pron: "du yu nóu if de stor is óu-pen", es: "¿Sabes si la tienda está abierta?" },
          { en: "Do you know where she lives?", pron: "du yu nóu uér shi livs", es: "¿Sabes dónde vive?" },
          { en: "Can you tell me what time it is?", pron: "kan yu tel mi uót táim it is", es: "¿Me dices qué hora es?" },
          { en: "I wonder if he's coming.", pron: "ai uán-der if jis ká-ming", es: "Me pregunto si vendrá." }
        ],
      }
    ],
    quiz: [
      { q: "¿Cuál está bien?", options: ["Do you know where is it?","Do you know where it is?","Do you know where is?"], answer: 1, why: "Dentro de otra frase, sujeto antes que verbo: where it is." },
      { q: "«No sé qué hora es» es…", options: ["I don't know what time is it","I don't know what time it is","I don't know what time is"], answer: 1, why: "Sin inversión: what time it is." },
      { q: "«Is it open?» dentro de otra frase pide…", options: ["that","if","what"], answer: 1, why: "Las preguntas de sí o no llevan if (o whether)." },
      { q: "¿Qué le sobra a «Tell me where does he live»?", options: ["el where","el does","el me"], answer: 1, why: "El auxiliar do/does/did desaparece dentro: where he lives." },
      { q: "«Can you tell me what time it ___?»", options: ["opens","does open","is open"], answer: 0, why: "Frase normal: sujeto (it) y verbo conjugado (opens)." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Los dos sirven para situarte en un momento del futuro y mirar desde allí. El futuro perfecto (will have + participio) dice qué estará YA TERMINADO para entonces: «para el viernes habré acabado». El futuro continuo (will be + -ing) dice qué estará EN MARCHA: «mañana a esta hora estaré volando».",
      },
      {
        t: "p",
        text: "No son tiempos de todos los días, pero salen mucho en el trabajo y en los planes: fechas límite, previsiones y agendas. Y la traducción es directa: «habré terminado» y «estaré trabajando».",
      },
      {
        t: "formula",
      ...
      {
        t: "table",
        head: ["Fórmula","Cuándo","Ejemplo"],
        rows: [
          ["will be + -ing","en marcha en ese momento","At 8 I'll be driving."],
          ["will have + participio","terminado antes de ese momento","By Friday I'll have finished."],
          ["will have been + -ing","duración hasta ese momento","By June I'll have been working here a year."]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        ...
        items: [
          ...
          { en: "This time tomorrow I'll be flying.", pron: "dis táim tu-mó-rou ail bi flái-ing", es: "Mañana a esta hora estaré volando." },
          { en: "She'll have left by then.", pron: "shil jav left bai den", es: "Para entonces ya se habrá ido." }
        ],
      }
    ],
    quiz: [
      { q: "«Para el viernes lo habré terminado» es…", options: ["By Friday I'll finish it","By Friday I'll have finished it","By Friday I'm finishing it"], answer: 1, why: "«By» + futuro pide will have + participio." },
      { q: "«A las ocho estaré conduciendo» es…", options: ["At 8 I'll drive","At 8 I'll be driving","At 8 I drive"], answer: 1, why: "En marcha en ese momento: will be + -ing." },
      { q: "Detrás de «will have» va…", options: ["el infinitivo","el participio","-ing"], answer: 1, why: "will have + participio: will have finished." },
      { q: "La palabra que anuncia el futuro perfecto es…", options: ["by","at","in"], answer: 0, why: "«By Friday», «by then»: marca el límite antes del cual estará hecho." },
      { q: "«Llevaré un año trabajando aquí» es…", options: ["I'll work here a year","I'll have been working here a year","I'm working here a year"], answer: 1, why: "Duración hasta un punto futuro: will have been + -ing." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "El español reparte esto entre yo, me, mi, mío y mí mismo, y el inglés hace lo mismo pero con reglas más rígidas: cada forma tiene su puesto y no se pueden intercambiar. Lo que decide cuál toca es la POSICIÓN en la frase, no el significado.",
      },
      {
        t: "p",
        text: "El orden es siempre el mismo: la forma sujeto (I, he, she) va delante del verbo; la forma objeto (me, him, her) va detrás del verbo o detrás de una preposición; el posesivo (my, his, her) siempre lleva un sustantivo pegado detrás; y la forma larga (mine, his, hers) va sola, sin sustantivo. Si te preguntas «¿qué va detrás?», ya tienes la respuesta.",
      },
      {
        t: "table",
        head: ["Sujeto","Objeto","Posesivo","Solo","Reflexivo","En español","En español"],
        rows: [
          ["I","me","my","mine","myself","yo · me · mi · el mío · yo mismo","yo · me · mi · el mío · yo mismo"],
          ["you","you","your","yours","yourself","tú · te · tu · el tuyo · tú mismo","tú · te · tu · el tuyo · tú mismo"],
          ["he","him","his","his","himself","él · lo/le · su · el suyo · él mismo","él · lo/le · su · el suyo · él mismo"],
          ["she","her","her","hers","herself","ella · la/le · su · el suyo · ella misma","ella · la/le · su · el suyo · ella misma"],
          ["it","it","its","—","itself","ello · lo · su · (el suyo) · sí mismo","ello · lo · su · (el suyo) · sí mismo"],
          ["we","us","our","ours","ourselves","nosotros · nos · nuestro · el nuestro · nosotros mismos","nosotros · nos · nuestro · el nuestro · nosotros mismos"],
          ["they","them","their","theirs","themselves","ellos · los/les · su · el suyo · ellos mismos","ellos · los/les · su · el suyo · ellos mismos"]
        ],
      },
      {
        t: "p",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "She told me it was hers.", pron: "shi tóuld mi it uós jers", es: "Me dijo que era suyo." },
          { en: "We did it ourselves.", pron: "ui did it au-ar-sélvs", es: "Lo hicimos nosotros mismos." },
          { en: "Their house is bigger than ours.", pron: "der jáus is bí-guer dan áu-ars", es: "Su casa es más grande que la nuestra." },
          { en: "She gave it to me.", pron: "shi guéiv it tu mi", es: "Me lo dio." },
          { en: "That book is mine.", pron: "dat buk is máin", es: "Ese libro es mío." },
          { en: "I did it myself.", pron: "ai did it mai-sélf", es: "Lo hice yo mismo." }
        ],
      }
    ],
    quiz: [
      { q: "«Este libro es mío» es…", options: ["This book is my","This book is mine","This book is me"], answer: 1, why: "Sin sustantivo detrás: mine." },
      { q: "«Me lo dio a mí» es…", options: ["He gave it to I","He gave it to me","He gave it to my"], answer: 1, why: "Detrás de preposición va la forma de objeto: me." },
      { q: "«Su casa» (de ella) es…", options: ["hers house","her house","she house"], answer: 1, why: "Delante de sustantivo va el posesivo: her." },
      { q: "«Me corté» es…", options: ["I cut me","I cut myself","I cut mine"], answer: 1, why: "Sujeto y objeto son la misma persona: reflexivo." },
      { q: "«its» es…", options: ["it is","el posesivo de it","un error"], answer: 1, why: "«it's» es it is; «its» sin apóstrofo es el posesivo." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Los tres caen en «ya» o «todavía» en español, y por eso se mezclan. Lo que de verdad los separa es una pregunta muy simple: ¿la cosa sigue pasando, ya pasó, o aún no ha pasado?",
      },
      {
        t: "p",
        text: "STILL es que sigue («todavía vivo aquí»). ALREADY es que ya pasó, y normalmente antes de lo esperado («ya he comido»). YET es que aún no ha pasado, y solo aparece en negativas y preguntas, siempre al final («¿ya has terminado?», «todavía no»). Con esas tres casillas no hay manera de confundirlos.",
      },
      {
        t: "table",
        head: ["Palabra","Significa","Dónde va","Ejemplo"],
        rows: [
          ["still","todavía (sigue pasando)","antes del verbo","I still live here."],
          ["yet","todavía no / ya (en preguntas)","al final","Have you finished yet?"],
          ["already","ya (antes de lo esperado)","antes del verbo o al final","I've already eaten."]
        ],
      },
      {
        t: "error",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "Are you still working here?", pron: "ar yu stil uér-king jí-er", es: "¿Sigues trabajando aquí?" },
          { en: "I haven't seen it yet.", pron: "ai já-vent siin it yet", es: "Todavía no lo he visto." },
          { en: "She has already left.", pron: "shi jas ol-ré-di left", es: "Ya se ha ido." },
          { en: "I still live with my parents.", pron: "ai stil liv uid mai pé-rents", es: "Todavía vivo con mis padres." },
          { en: "Have you finished yet?", pron: "jav yu fí-nisht yet", es: "¿Ya has terminado?" },
          { en: "She's already gone.", pron: "shis ol-ré-di gon", es: "Ya se ha ido." }
        ],
      }
    ],
    quiz: [
      { q: "«Todavía no he comido» es…", options: ["I haven't eaten still","I haven't eaten yet","I haven't eaten already"], answer: 1, why: "Negativa: yet, y al final." },
      { q: "«Sigo viviendo aquí» es…", options: ["I still live here","I yet live here","I already live here"], answer: 0, why: "Algo que continúa: still, antes del verbo." },
      { q: "«Ya he terminado» es…", options: ["I've finished yet","I've already finished","I've still finished"], answer: 1, why: "Afirmar que ya pasó: already." },
      { q: "«Yet» va normalmente…", options: ["al principio","al final","antes del verbo"], answer: 1, why: "Al final de la frase: Have you finished yet?" },
      { q: "«He still hasn't called» transmite…", options: ["Neutralidad","Impaciencia","Alegría"], answer: 1, why: "Still en negativa añade el matiz de «y ya está tardando»." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "El problema de estos adverbios no es lo que significan —eso está claro— sino dónde se colocan, porque el inglés los mete en un sitio muy concreto y el español los pone casi en cualquier parte.",
      },
      {
        t: "p",
        text: "La regla tiene tres casos y no falla: van ENTRE el sujeto y el verbo normal («I always work»), DETRÁS del verbo «to be» («I am always late») y DETRÁS del primer auxiliar si lo hay («I have never been there»). El error típico del hispanohablante es mandarlos al final («I go to the gym always»), que en español suena perfecto y en inglés no.",
      },
      {
        t: "formula",
      ...
      {
        t: "table",
        head: ["Adverbio","Cuánto","Ejemplo"],
        rows: [
          ["always","100%","She always works late."],
          ["usually / normally","80%","I usually walk."],
          ["often","60%","We often meet here."],
          ["sometimes","40%","He sometimes calls."],
          ["rarely / seldom","10%","They rarely go out."],
      ...
      },
      {
        t: "examples",
        items: [
          { en: "I never eat breakfast.", pron: "ai né-ver iit brék-fast", es: "Nunca desayuno." },
          { en: "He is always late.", pron: "ji is ól-uis léit", es: "Siempre llega tarde." },
          { en: "We have never been to Japan.", pron: "ui jav né-ver bin tu ya-pán", es: "Nunca hemos estado en Japón." },
          { en: "I always have coffee in the morning.", pron: "ai ól-ueis jav kó-fi in de mór-ning", es: "Siempre tomo café por la mañana." },
          { en: "He is never late.", pron: "ji is né-ver léit", es: "Nunca llega tarde." },
          { en: "We sometimes eat out.", pron: "ui sám-taims iit áut", es: "A veces comemos fuera." }
        ],
      }
    ],
    quiz: [
      { q: "«Siempre voy al gimnasio» es…", options: ["I go always to the gym","I always go to the gym","Always I go to the gym"], answer: 1, why: "Delante del verbo normal." },
      { q: "Con el verbo «be», el adverbio va…", options: ["delante","detrás","al final"], answer: 1, why: "I am always tired, no I always am tired." },
      { q: "«Nunca he estado allí» es…", options: ["I never have been there","I have never been there","I have been never there"], answer: 1, why: "Con auxiliar, el adverbio va en medio: have never been." },
      { q: "¿Cuál puede ir al principio de la frase?", options: ["always","never","sometimes"], answer: 2, why: "Sometimes y usually sí; always y never no." },
      { q: "«Rarely» significa…", options: ["muy a menudo","casi nunca","raro"], answer: 1, why: "Es frecuencia baja, no rareza." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Los cuatro sirven para medir la intensidad de algo, y cada uno se coloca en un sitio distinto. Es la típica lección en la que el significado se entiende a la primera y lo que cuesta es acordarse de la posición.",
      },
      {
        t: "p",
        text: "SO va con un adjetivo solo («so tired»); SUCH va con un sustantivo, lleve adjetivo o no («such a good day»). TOO va DELANTE del adjetivo y siempre es negativo, porque significa que se pasa del límite («too expensive» = tan caro que no lo compro). Y ENOUGH es el único que va DETRÁS del adjetivo («old enough»), justo al revés que en español, donde decimos «suficientemente mayor».",
      },
      {
        t: "table",
        head: ["Palabra","Va con","Ejemplo"],
        rows: [
          ["so","adjetivo o adverbio solo","It's so cold."],
          ["such","(a/an) + adjetivo + sustantivo","It's such a cold day."],
          ["too","adjetivo: más de lo aceptable","It's too cold to go out."],
          ["enough","DETRÁS del adjetivo","It's not warm enough."]
        ],
      },
      {
        t: "error",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "It's too late to call her.", pron: "its tu léit tu kol jer", es: "Es demasiado tarde para llamarla." },
          { en: "He's not old enough to drive.", pron: "jis not óuld i-náf tu dráiv", es: "No tiene edad suficiente para conducir." },
          { en: "It was such a good movie.", pron: "it uós sach a gud múu-vi", es: "Fue una película tan buena." },
          { en: "It's so hot today.", pron: "its sóu jot tu-déi", es: "Hace tanto calor hoy." },
          { en: "It was such a good day.", pron: "it uós sach a gud déi", es: "Fue un día tan bueno." },
          { en: "He isn't old enough.", pron: "ji í-sent óuld i-náf", es: "No tiene edad suficiente." }
        ],
      }
    ],
    quiz: [
      { q: "«Hace un día tan bonito» es…", options: ["It's a so nice day","It's such a nice day","It's so a nice day"], answer: 1, why: "Con sustantivo detrás: such a + adjetivo + sustantivo." },
      { q: "«Este café está demasiado caliente» es…", options: ["This coffee is very hot","This coffee is too hot","This coffee is so hot"], answer: 1, why: "Too = más de lo aceptable, no te lo puedes beber." },
      { q: "«Enough» con un adjetivo va…", options: ["delante","detrás","da igual"], answer: 1, why: "old enough, good enough: siempre detrás del adjetivo." },
      { q: "«No tengo suficiente dinero» es…", options: ["I don't have money enough","I don't have enough money","I don't have too money"], answer: 1, why: "Con sustantivo, enough va delante." },
      { q: "«Too» y «very» son…", options: ["Lo mismo","Distintos: too es negativo","Too es más formal"], answer: 1, why: "Very solo intensifica; too dice que se pasa de la raya." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Español","Inglés correcto","El calco típico"],
        rows: [
          ["No sé nada","I don't know anything","I don't know nothing"],
          ["No he visto a nadie","I haven't seen anyone","I haven't seen nobody"],
          ["No fui a ninguna parte","I didn't go anywhere","I didn't go nowhere"],
          ["Tampoco tengo","I don't have any either","I don't have neither"]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "I didn't see anyone there.", pron: "ai dí-dent sii é-ni-uan der", es: "No vi a nadie allí." },
          { en: "There isn't anything left.", pron: "der í-sent é-ni-zing left", es: "No queda nada." },
          { en: "She never says anything.", pron: "shi né-ver ses é-ni-zing", es: "Nunca dice nada." },
          { en: "I don't know anything about it.", pron: "ai dóunt nóu é-ni-zing a-báut it", es: "No sé nada de eso." },
          { en: "There's nobody here.", pron: "ders nóu-bo-di jier", es: "No hay nadie aquí." },
          { en: "I never say anything.", pron: "ai né-ver séi é-ni-zing", es: "Nunca digo nada." }
        ],
      }
    ],
    quiz: [
...

  {
    ...
    blocks: [
      ...
      {
        t: "p",
        text: "Solo hay cuatro y se eligen con dos preguntas: ¿está cerca o lejos? y ¿es uno o son varios? Cerca y uno, THIS. Cerca y varios, THESE. Lejos y uno, THAT. Lejos y varios, THOSE.",
      },
      {
        t: "p",
        text: "La diferencia con el español es que nosotros tenemos TRES distancias —este, ese y aquel— y el inglés solo dos. Eso significa que «ese» y «aquel» caen los dos en «that», y no hay manera de distinguirlos: si necesitas marcar que algo está muy lejos, hay que añadirlo aparte («that one over there»).",
      },
      {
        t: "table",
        head: ["","Cerca","Lejos"],
        rows: [
          ["Uno","this (este)","that (ese, aquel)"],
          ["Varios","these (estos)","those (esos, aquellos)"]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "These are my keys.", pron: "diis ar mái kiis", es: "Estas son mis llaves." },
          { en: "Look at those birds.", pron: "luk at dóus berds", es: "Mira esos pájaros." },
          { en: "Hi, this is Ana.", pron: "jái, dis is á-na", es: "Hola, soy Ana." },
          { en: "This is my favorite song.", pron: "dis is mai féi-vo-rit song", es: "Esta es mi canción favorita." },
          { en: "Those shoes are expensive.", pron: "dóus shuus ar iks-pén-siv", es: "Esos zapatos son caros." },
          { en: "What's that noise?", pron: "uóts dat nóis", es: "¿Qué es ese ruido?" }
        ],
      }
    ],
    quiz: [
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Se escribe","Se dice","Qué ha pasado"],
        rows: [
          ["an apple","a-nápol","la consonante salta a la vocal siguiente"],
          ["want to","uóna","want to se funde en wanna"],
          ["going to","góna","going to se funde en gonna"],
          ["got to","góra","got to se funde en gotta"],
          ["what do you","uó-ra-yu","se come casi todo"],
          ["did you","dí-yu","la d y la y se juntan en una sola"]
        ],
      },
      {
        t: "p",
    ...
    quiz: [
      { q: "«an apple» suena…", options: ["an-apol","a-nápol","an-ápol"], answer: 1, why: "La n salta a la vocal siguiente: es un solo bloque." },
      { q: "«going to» hablado suena…", options: ["góing tu","góna","gou-tu"], answer: 1, why: "Se funde en «gonna», y es lo normal al hablar." },
      { q: "La regla principal del enlace es…", options: ["Consonante + vocal se pegan","Se comen las vocales","Se acelera el final"], answer: 0, why: "Si acaba en consonante y sigue vocal, la consonante se va con la vocal." },
      { q: "«Turn it off» suena…", options: ["turn it of","ter-ni-tof","turni-tof"], answer: 1, why: "Tres palabras que se reparten en tres sílabas nuevas." },
      { q: "Lo mejor para entrenar el oído es…", options: ["Escuchar más despacio","Practicar tú a pegar las palabras","Leer más"], answer: 1, why: "Producirlo tú es lo que te enseña a reconocerlo." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Frase negativa","«Yo tampoco»","Nunca","En español"],
        rows: [
          ["I don't like it.","Neither do I.","Neither don't I.","No me gusta. — A mí tampoco."],
          ["I'm not tired.","Neither am I.","Neither am not I.","No estoy cansado. — Yo tampoco."],
          ["I didn't go.","Neither did I.","Neither didn't I.","No fui. — Yo tampoco."],
          ["I can't swim.","Neither can I.","Neither can't I.","No sé nadar. — Yo tampoco."]
        ],
      },
      {
        t: "error",
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Larga","Corta","Ejemplo","En español"],
        rows: [
          ["I am","I'm","I'm ready.","Estoy listo."],
          ["you are","you're","You're late.","Llegas tarde."],
          ["he is / he has","he's","He's here.","Está aquí."],
          ["we are","we're","We're waiting.","Estamos esperando."],
          ["they are","they're","They're coming.","Vienen ya."],
          ["do not","don't","I don't know.","No lo sé."],
          ["does not","doesn't","She doesn't care.","A ella le da igual."],
          ["did not","didn't","We didn't go.","No fuimos."],
          ["cannot","can't","I can't swim.","No sé nadar."],
          ["will not","won't","He won't come.","No va a venir."],
          ["I would / I had","I'd","I'd like a coffee.","Querría un café."],
          ["I will","I'll","I'll call you.","Te llamo."]
        ],
      },
      {
        t: "p",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { en: "I'm studying English.", pron: "aim stá-di-ing ín-glish", es: "Estoy estudiando inglés." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Quieto (in / on / at)","En movimiento (into / onto / to)","En español"],
        rows: [
          ["He is in the car.","He got into the car.","Está en el coche / Se metió en el coche."],
          ["The book is on the table.","I put the book onto the table.","El libro está en la mesa / Puse el libro en la mesa."],
          ["She is at the office.","She went to the office.","Está en la oficina / Fue a la oficina."]
        ],
      },
      {
        t: "tip",
      ...
      },
      {
        t: "examples",
        items: [
          { en: "I'm going home now.", pron: "aim gó-ing jóum náu", es: "Me voy a casa ahora." },
...

  {
    ...
    blocks: [
      ...
      {
        t: "table",
        head: ["Correcto","Correcto","Incorrecto","En español"],
        rows: [
          ["I studied at home yesterday.","Yesterday I studied at home.","I studied yesterday at home.","Estudié ayer en casa."],
          ["We met in Madrid last year.","Last year we met in Madrid.","We met last year in Madrid.","Nos conocimos en Madrid el año pasado."]
        ],
      },
      {
        t: "tip",
...

  {
    ...
    blocks: [
      ...
      {
        t: "formula",
        parts: ["verbo","persona","to","verbo base"],
        example: "I want you to come.",
      },
      {
        t: "table",
        head: ["Español","Inglés","Qué pasó con el «que»"],
        rows: [
          ["Quiero que vengas.","I want you to come.","Desaparece: se sustituye por «to»."],
          ["Quiero que me llames.","I want you to call me.","Igual: you + to call."],
          ["Le dije que esperara.","I told him to wait.","him + to wait, sin «that»."],
          ["Le pedí que me ayudara.","I asked her to help me.","her + to help."],
          ["Espero que llegue pronto.","I expect him to arrive soon.","him + to arrive."],
          ["No me dejaron entrar.","They didn't allow me to enter.","me + to enter."]
        ],
      },
      {
        t: "error",
        wrong: "I want that you come. / I want you come. / I want that you come tomorrow.",
        right: "I want you to come.",
        why: "«That» no cabe aquí, y el «to» no se puede quitar. La estructura es persona + to + verbo, siempre las tres piezas.",
      },
      {
        t: "p",
        text: "Fíjate en un detalle que cuesta: la persona va en forma OBJETO, no sujeto. Es «I want HIM to come», nunca «I want HE to come», aunque en español «él» sea el que hace la acción de venir. En inglés, esa persona es el objeto del verbo «want», y por eso se pone him, her, me, us, them.",
      },
      {
        t: "table",
        head: ["Sujeto","Objeto (el que va aquí)","Ejemplo"],
        rows: [
          ["I","me","She wants me to stay."],
          ["he","him","I want him to call."],
          ["she","her","I told her to wait."],
          ["we","us","They asked us to help."],
          ["they","them","I need them to answer."]
        ],
      },
      {
        t: "tip",
      ...
      {
        t: "table",
        head: ["Verbo","Estructura","Ejemplo"],
        rows: [
          ["want, tell, ask, expect, allow","persona + TO + verbo","I told him to wait."],
          ["make, let, have","persona + verbo pelado","I made him wait."],
          ["help","las dos valen","I helped him (to) wait."],
          ["say","NO admite persona","I said that he should wait."]
        ],
      },
      {
        t: "examples",
        items: [
          { en: "I want you to come with me.", pron: "ai uónt yu tu kam uid mi", es: "Quiero que vengas conmigo." },
          { en: "She told me to wait here.", pron: "shi tóuld mi tu uéit jier", es: "Me dijo que esperara aquí." },
          { en: "I asked him to call me back.", pron: "ai askt jim tu kol mi bak", es: "Le pedí que me devolviera la llamada." },
          { en: "They don't allow us to park here.", pron: "déi dóunt a-láu as tu park jier", es: "No nos dejan aparcar aquí." },
          { en: "I need her to answer today.", pron: "ai niid jer tu án-ser tu-déi", es: "Necesito que conteste hoy." },
          { en: "We expect them to arrive at six.", pron: "ui iks-pékt dem tu a-ráiv at siks", es: "Esperamos que lleguen a las seis." }
        ],
      }
    ],
    quiz: [
      { q: "«Quiero que vengas» es…", options: ["I want that you come","I want you to come","I want you come"], answer: 1, why: "El «que» español se convierte en «to»: persona + to + verbo." },
      { q: "El «que» del español aquí se traduce…", options: ["por «that»","por «to»","por nada, se omite"], answer: 1, why: "Se sustituye por «to», que es lo que une la persona con el verbo." },
      { q: "«Quiero que él llame» es…", options: ["I want he to call","I want him to call","I want that he calls"], answer: 1, why: "La persona va en forma objeto: him, no he." },
      ...
      { q: "El truco para traducirlo al vuelo es…", options: ["buscar «that»","convertir «que + subjuntivo» en «a alguien hacer»","usar el gerundio"], answer: 1, why: "«Quiero que vengas» → «te quiero a ti venir» → I want you to come." }
    ],
  },

  {
    id: "conectores-contraste",
    title: "but, although, however: llevar la contraria",
    tag: "Estructuras",
    goal: "Elegir entre «pero», «aunque» y «sin embargo» sin equivocarte de sitio.",
    blocks: [
      {
        t: "p",
        text: "Todos significan más o menos «pero», y por eso se mezclan. Lo que de verdad los separa no es el significado: es qué tipo de palabra va detrás y dónde puede colocarse cada uno. Con eso queda resuelto.",
      },
      {
        t: "table",
        head: ["Palabra","Español","Detrás va","Ejemplo"],
        rows: [
          ["but","pero","una frase entera","It's small but it's nice."],
          ["although / though","aunque","una frase entera","Although it's small, it's nice."],
          ["however","sin embargo","una frase entera, con punto o punto y coma antes","It's small. However, it's nice."],
          ["despite / in spite of","a pesar de","un sustantivo o un -ing","Despite the rain, we went out."]
        ],
      },
      {
        t: "p",
        text: "La diferencia clave está en la última fila: DESPITE y IN SPITE OF no admiten una frase con sujeto y verbo detrás. Solo aceptan un sustantivo o un verbo en -ing. Es la trampa que más se falla, porque en español «a pesar de que llovía» sí lleva frase entera.",
      },
      {
        t: "error",
        wrong: "Despite it was raining, we went out. / Although the rain, we went out.",
        right: "Despite the rain, we went out. / Although it was raining, we went out.",
        why: "«Despite» pide sustantivo o -ing; «although» pide frase con sujeto y verbo. Si quieres usar «despite» con una frase entera, hay que añadir «the fact that»: «despite the fact that it was raining».",
      },
      {
        t: "table",
        head: ["Con frase (sujeto + verbo)","Con sustantivo o -ing"],
        rows: [
          ["Although it was raining…","Despite the rain…"],
          ["Although he was tired…","Despite being tired…"],
          ["Even though it's expensive…","In spite of the price…"]
        ],
      },
      {
        t: "tip",
        text: "Truco de bolsillo: ALTHOUGH lleva verbo, DESPITE no. Si detrás quieres poner «it was», «he is» o cualquier sujeto + verbo, tiene que ser «although» o «even though». Si detrás solo hay una cosa («the rain», «the price», «being tired»), entonces «despite» o «in spite of».",
      },
      {
        t: "p",
        text: "Y ojo con dos posiciones que el español permite y el inglés no. Primero: «but» nunca empieza una frase formal — va en medio, uniendo. Segundo: «however» sí empieza frase, pero va separado por coma y detrás de un punto o punto y coma, nunca uniendo dos frases con una coma sola.",
      },
      {
        t: "table",
        head: ["Correcto","Incorrecto","Por qué"],
        rows: [
          ["It's small, but it's nice.","It's small, however it's nice.","However necesita punto o punto y coma antes."],
          ["It's small. However, it's nice.","It's small. But, it's nice.","«But» une, no abre."],
          ["Although it's small, it's nice.","Although it's small, but it's nice.","No se ponen los dos: uno u otro."]
        ],
      },
      {
        t: "tip",
        text: "El error de poner los dos («aunque… pero…») viene directo del español hablado, donde sí lo decimos: «aunque es pequeño, pero es bonito». En inglés escoges uno y punto. Si empiezas con «although», la segunda mitad va sola.",
      },
      {
        t: "examples",
        items: [
          { en: "It's small, but it's nice.", pron: "its smol, bat its náis", es: "Es pequeño, pero es bonito." },
          { en: "Although it was raining, we went out.", pron: "ol-dóu it uós réi-ning, ui uent áut", es: "Aunque llovía, salimos." },
          { en: "Despite the rain, we went out.", pron: "dis-páit de réin, ui uent áut", es: "A pesar de la lluvia, salimos." },
          { en: "The hotel was cheap. However, it was very clean.", pron: "de jou-tél uós chiip. jau-é-ver, it uós vé-ri kliin", es: "El hotel era barato. Sin embargo, estaba muy limpio." },
          { en: "He came despite being tired.", pron: "ji kéim dis-páit bí-ing tái-erd", es: "Vino a pesar de estar cansado." },
          { en: "Even though I studied, I failed.", pron: "íi-ven dóu ai stá-did, ai féild", es: "Aunque estudié, suspendí." }
        ],
      }
    ],
    quiz: [
      { q: "Detrás de «despite» va…", options: ["una frase con sujeto y verbo","un sustantivo o un -ing","un adjetivo"], answer: 1, why: "«Despite the rain», «despite being tired»." },
      { q: "Detrás de «although» va…", options: ["un sustantivo","una frase con sujeto y verbo","un -ing"], answer: 1, why: "«Although it was raining»." },
      { q: "«A pesar de la lluvia» es…", options: ["Although the rain","Despite the rain","However the rain"], answer: 1, why: "Sustantivo detrás: despite." },
      { q: "«Aunque llovía» es…", options: ["Despite it was raining","Although it was raining","However it was raining"], answer: 1, why: "Frase con verbo: although." },
      { q: "¿Qué está mal en «Although it's small, but it's nice»?", options: ["Nada","Sobra «but»: se usa uno u otro","Falta una coma"], answer: 1, why: "El español dice los dos; el inglés escoge uno." },
      { q: "«However» necesita antes…", options: ["una coma","un punto o punto y coma","nada"], answer: 1, why: "«It's small. However, it's nice.»" },
      { q: "Para usar «despite» con una frase entera hay que añadir…", options: ["that","the fact that","which"], answer: 1, why: "«Despite the fact that it was raining»." },
      { q: "«Vino a pesar de estar cansado» es…", options: ["He came despite he was tired","He came despite being tired","He came although tired"], answer: 1, why: "Con -ing detrás de despite." },
      { q: "El truco para elegir es…", options: ["although lleva verbo, despite no","despite es más formal","son intercambiables"], answer: 0, why: "Si detrás hay sujeto + verbo, es although." },
      { q: "«Though» es…", options: ["distinto de although","lo mismo que although, más informal","un sustantivo"], answer: 1, why: "Significan lo mismo; «though» es más de conversación." },
      { q: "«Sin embargo» es…", options: ["but","however","despite"], answer: 1, why: "«However» abre frase nueva tras punto." }
    ],
  },

  {
    id: "conectores-causa",
    title: "because, so y therefore: causa y consecuencia",
    tag: "Estructuras",
    goal: "Encadenar el porqué y el por eso sin liarte.",
    blocks: [
      {
        t: "p",
        text: "Son la otra mitad de los conectores: los que explican POR QUÉ pasa algo y los que dicen QUÉ PASA por eso. La clave está en el orden — cada uno va delante de una mitad distinta de la frase, y confundirlos le da la vuelta al sentido.",
      },
      {
        t: "table",
        head: ["Palabra","Español","Introduce","Ejemplo"],
        rows: [
          ["because","porque","la CAUSA","I stayed home because I was tired."],
          ["since / as","ya que, como","la CAUSA (más formal)","Since it was late, we left."],
          ["so","así que","la CONSECUENCIA","I was tired, so I stayed home."],
          ["therefore","por lo tanto","la CONSECUENCIA (formal)","It rained. Therefore, we canceled."],
          ["that's why","por eso","la CONSECUENCIA","I was tired. That's why I stayed home."]
        ],
      },
      {
        t: "p",
        text: "Fíjate en las dos primeras filas y las tres últimas: «because» va delante de la causa y «so» delante de la consecuencia. Son la misma idea contada al revés. «I was tired, SO I stayed home» y «I stayed home BECAUSE I was tired» dicen exactamente lo mismo, pero cada palabra ocupa el lado contrario.",
      },
      {
        t: "table",
        head: ["Frase","Qué va delante","Qué va detrás"],
        rows: [
          ["I stayed home because I was tired.","la consecuencia","la causa"],
          ["I was tired, so I stayed home.","la causa","la consecuencia"],
          ["Because I was tired, I stayed home.","la causa","la consecuencia"]
        ],
      },
      {
        t: "error",
        wrong: "Because I was tired, so I stayed home.",
        right: "Because I was tired, I stayed home. / I was tired, so I stayed home.",
        why: "Es el mismo error que «aunque… pero…»: en español encadenamos los dos y en inglés hay que elegir uno. Si empiezas con «because», la segunda mitad va sin «so».",
      },
      {
        t: "tip",
        text: "Truco para no equivocarte al hablar: pregúntate qué viene DESPUÉS de la palabra. Si detrás va el motivo, es BECAUSE. Si detrás va el resultado, es SO. «Me quedé en casa ___ estaba cansado» → detrás va el motivo → because. «Estaba cansado, ___ me quedé en casa» → detrás va el resultado → so.",
      },
      {
        t: "p",
        text: "Cuidado con dos parejas que se confunden por parecerse a palabras españolas. «Because» y «because of» no son lo mismo: «because» lleva frase con verbo y «because of» lleva un sustantivo — es el mismo reparto que «although» y «despite». Y «so» tiene otro uso completamente distinto delante de un adjetivo, donde significa «tan».",
      },
      {
        t: "table",
        head: ["Forma","Detrás va","Ejemplo","Español"],
        rows: [
          ["because","sujeto + verbo","because it was raining","porque llovía"],
          ["because of","sustantivo","because of the rain","por la lluvia"],
          ["so + frase","consecuencia","so I stayed home","así que me quedé"],
          ["so + adjetivo","intensidad","so tired","tan cansado"]
        ],
      },
      {
        t: "p",
        text: "Y una nota de registro: «therefore» suena a informe o a examen. En conversación normal nadie lo usa — se dice «so» o «that's why». Está bien reconocerlo al leer, pero si estás hablando, «so» siempre encaja.",
      },
      {
        t: "examples",
        items: [
          { en: "I stayed home because I was tired.", pron: "ai stéid jóum bi-kós ai uós tái-erd", es: "Me quedé en casa porque estaba cansado." },
          { en: "I was tired, so I stayed home.", pron: "ai uós tái-erd, sóu ai stéid jóum", es: "Estaba cansado, así que me quedé en casa." },
          { en: "We canceled because of the rain.", pron: "ui kán-seld bi-kós ov de réin", es: "Lo cancelamos por la lluvia." },
          { en: "Since it was late, we left.", pron: "sins it uós léit, ui left", es: "Como era tarde, nos fuimos." },
          { en: "I forgot my keys. That's why I called you.", pron: "ai for-gót mai kiis. dats uái ai kold yu", es: "Olvidé las llaves. Por eso te llamé." },
          { en: "I'm so tired today.", pron: "aim sóu tái-erd tu-déi", es: "Estoy tan cansado hoy." }
        ],
      }
    ],
    quiz: [
      { q: "«Because» introduce…", options: ["la consecuencia","la causa","una condición"], answer: 1, why: "Detrás de «because» va el motivo." },
      { q: "«So» introduce…", options: ["la causa","la consecuencia","una condición"], answer: 1, why: "Detrás de «so» va el resultado." },
      { q: "«Estaba cansado, así que me quedé» es…", options: ["I was tired, because I stayed","I was tired, so I stayed","Because I was tired, so I stayed"], answer: 1, why: "Detrás va el resultado: so." },
      { q: "¿Qué está mal en «Because I was tired, so I stayed home»?", options: ["Nada","Sobra «so»: se usa uno u otro","Falta un punto"], answer: 1, why: "Mismo error que «aunque… pero…»: en inglés se elige uno." },
      { q: "Detrás de «because of» va…", options: ["sujeto + verbo","un sustantivo","un adjetivo"], answer: 1, why: "«Because of the rain», no «because of it was raining»." },
      { q: "«Por la lluvia» es…", options: ["because the rain","because of the rain","so the rain"], answer: 1, why: "Sustantivo detrás: because of." },
      { q: "«So tired» significa…", options: ["así que cansado","tan cansado","muy poco cansado"], answer: 1, why: "Delante de un adjetivo, «so» es «tan»." },
      { q: "«Therefore» se usa sobre todo…", options: ["al hablar en la calle","en textos formales o informes","con amigos"], answer: 1, why: "En conversación se dice «so» o «that's why»." },
      { q: "El truco para elegir es preguntarse…", options: ["si es formal","qué viene DESPUÉS: el motivo o el resultado","cuántas palabras hay"], answer: 1, why: "Motivo detrás → because. Resultado detrás → so." },
      { q: "«Como era tarde, nos fuimos» es…", options: ["How it was late, we left","Since it was late, we left","So it was late, we left"], answer: 1, why: "«Since» y «as» valen para «como / ya que»." },
      { q: "«Por eso te llamé» es…", options: ["For that I called you","That's why I called you","Because I called you"], answer: 1, why: "«That's why» es la forma natural de «por eso»." }
    ],
  },

  {
    id: "gerundio-sujeto",
    title: "«Swimming is good»: el -ing como sujeto",
    tag: "Palabras",
    goal: "Empezar frases con un verbo sin usar el infinitivo español.",
    blocks: [
      {
        t: "p",
        text: "Cuando en español una frase empieza por un verbo —«Nadar es bueno», «Fumar mata», «Aprender idiomas cuesta»— usamos el INFINITIVO. El inglés en esa posición usa el -ING. Es una regla mecánica y sin excepciones prácticas: si el verbo hace de sujeto, va en -ing.",
      },
      {
        t: "table",
        head: ["Español","Inglés","Qué cambia"],
        rows: [
          ["Nadar es bueno para ti.","Swimming is good for you.","nadar → swimming"],
          ["Fumar mata.","Smoking kills.","fumar → smoking"],
          ["Aprender idiomas lleva tiempo.","Learning languages takes time.","aprender → learning"],
          ["Leer me relaja.","Reading relaxes me.","leer → reading"],
          ["Conducir de noche es difícil.","Driving at night is hard.","conducir → driving"]
        ],
      },
      {
        t: "error",
        wrong: "To swim is good for you. / Swim is good for you.",
        right: "Swimming is good for you.",
        why: "«To swim» no está mal del todo, pero suena a libro antiguo y nadie habla así. Y el verbo pelado («swim») no puede ser sujeto: haría de imperativo, que es otra cosa.",
      },
      {
        t: "p",
        text: "Este -ing no es el del presente continuo aunque se escriba igual. Aquí el verbo se ha convertido en un SUSTANTIVO: «swimming» funciona como «la natación». Por eso lleva verbo en singular detrás («swimming IS», no «swimming are») y puede llevar adjetivos o complementos como cualquier sustantivo.",
      },
      {
        t: "table",
        head: ["Frase","El -ing hace de","Verbo detrás"],
        rows: [
          ["Swimming is good.","sujeto (la natación)","is, singular"],
          ["I like swimming.","objeto (nadar)","—"],
          ["Smoking is bad for you.","sujeto (el fumar)","is, singular"],
          ["Learning English takes time.","sujeto con complemento","takes, singular"]
        ],
      },
      {
        t: "tip",
        text: "Truco para reconocerlo al vuelo: si puedes poner «el hecho de» delante en español, es este -ing. «El hecho de fumar mata» → Smoking kills. «El hecho de nadar es bueno» → Swimming is good. Si la frase no admite ese «el hecho de», seguramente el verbo no está haciendo de sujeto.",
      },
      {
        t: "p",
        text: "La misma regla explica dos cosas que ya has visto en otras lecciones y que ahora encajan: detrás de una preposición siempre va -ing («good at cooking», «before leaving»), y detrás de ciertos verbos también («I enjoy reading»). En los tres casos es lo mismo — el verbo está funcionando como un sustantivo, y en esa función el inglés usa -ing.",
      },
      {
        t: "table",
        head: ["Posición","Ejemplo","En español"],
        rows: [
          ["sujeto","Cooking is fun.","Cocinar es divertido."],
          ["tras preposición","I'm good at cooking.","Se me da bien cocinar."],
          ["tras ciertos verbos","I enjoy cooking.","Disfruto cocinando."],
          ["tras posesivo","His cooking is great.","Cocina genial."]
        ],
      },
      {
        t: "examples",
        items: [
          { en: "Swimming is good for you.", pron: "suí-ming is gud for yu", es: "Nadar es bueno para ti." },
          { en: "Smoking kills.", pron: "smóu-king kils", es: "Fumar mata." },
          { en: "Learning English takes time.", pron: "lér-ning ín-glish téiks táim", es: "Aprender inglés lleva tiempo." },
          { en: "Reading before bed helps me sleep.", pron: "ríi-ding bi-fór bed jelps mi sliip", es: "Leer antes de dormir me ayuda a dormir." },
          { en: "Driving at night is hard for me.", pron: "drái-ving at náit is jard for mi", es: "Conducir de noche se me hace difícil." },
          { en: "Waiting is the worst part.", pron: "uéi-ting is de uerst part", es: "Esperar es lo peor." }
        ],
      }
    ],
    quiz: [
      { q: "«Nadar es bueno» es…", options: ["To swim is good","Swimming is good","Swim is good"], answer: 1, why: "Un verbo que hace de sujeto va en -ing." },
      { q: "El español en esa posición usa…", options: ["el gerundio","el infinitivo","el participio"], answer: 1, why: "«Nadar», «fumar», «leer»: infinitivo donde el inglés pone -ing." },
      { q: "«Fumar mata» es…", options: ["Smoke kills","To smoke kills","Smoking kills"], answer: 2, why: "Smoking, como sujeto." },
      { q: "«Swimming is good» lleva «is» porque…", options: ["swimming es plural","el -ing funciona como un sustantivo singular","es una excepción"], answer: 1, why: "Swimming = la natación: singular." },
      { q: "¿Por qué «Swim is good» está mal?", options: ["Falta un artículo","El verbo pelado no puede ser sujeto","Falta «to»"], answer: 1, why: "«Swim» solo haría de imperativo." },
      { q: "«To swim is good» es…", options: ["incorrecto","correcto pero suena antiguo y libresco","lo más normal"], answer: 1, why: "Existe, pero en el habla real se usa -ing." },
      { q: "El truco para reconocerlo es…", options: ["contar sílabas","probar a poner «el hecho de» delante en español","buscar preposiciones"], answer: 1, why: "«El hecho de fumar mata» → Smoking kills." },
      { q: "«Aprender inglés lleva tiempo» es…", options: ["Learn English takes time","Learning English takes time","To learn English take time"], answer: 1, why: "Learning como sujeto, y «takes» en singular." },
      { q: "Detrás de una preposición va…", options: ["infinitivo","-ing","el verbo pelado"], answer: 1, why: "Es el mismo mecanismo: el verbo hace de sustantivo." },
      { q: "«Esperar es lo peor» es…", options: ["Wait is the worst part","To wait is the worst part","Waiting is the worst part"], answer: 2, why: "Sujeto → -ing." },
      { q: "Este -ing y el del presente continuo…", options: ["son la misma cosa","se escriben igual pero hacen funciones distintas","no se parecen"], answer: 1, why: "Aquí el verbo hace de sustantivo; allí forma un tiempo verbal." }
    ],
  },

  {
    id: "adjetivos-preposicion",
    title: "good at, afraid of: la preposición del adjetivo",
    tag: "Palabras",
    goal: "Acertar la preposición que va pegada a cada adjetivo.",
    blocks: [
      {
        t: "p",
        text: "Ya viste que los verbos llevan su preposición fija (depend on, listen to). Los adjetivos también, y aquí el problema es el mismo: la preposición inglesa casi nunca coincide con la española, así que traducir palabra por palabra falla. Hay que aprenderse el adjetivo Y su preposición como una sola pieza.",
      },
      {
        t: "table",
        head: ["Inglés","Español","La trampa"],
        rows: [
          ["good at / bad at","bueno / malo EN","no «good in»"],
          ["interested in","interesado EN","aquí sí coincide"],
          ["afraid of / scared of","tener miedo A","«of», no «to»"],
          ["married to","casado CON","«to», no «with»"],
          ["proud of","orgulloso DE","coincide"],
          ["worried about","preocupado POR","«about», no «for»"],
          ["angry with","enfadado CON","con personas: «with»"],
          ["different from","diferente A / DE","«from», nunca «to»"],
          ["similar to","parecido A","coincide"],
          ["responsible for","responsable DE","«for», no «of»"],
          ["full of","lleno DE","coincide"],
          ["famous for","famoso POR","«for»"]
        ],
      },
      {
        t: "p",
        text: "Y detrás de esa preposición, si viene un verbo, va SIEMPRE en -ing. Es la misma regla que ya conoces: tras preposición, -ing. «Se me da bien cocinar» no es «good at cook» ni «good at to cook»: es «good at cookING».",
      },
      {
        t: "error",
        wrong: "I'm good in English. / She's married with a doctor. / I'm afraid to spiders.",
        right: "I'm good at English. / She's married to a doctor. / I'm afraid of spiders.",
        why: "Las tres salen de traducir la preposición española. «Bueno en» no es «good in», «casado con» no es «married with» y «miedo a» no es «afraid to».",
      },
      {
        t: "tip",
        text: "Truco para agruparlas y no memorizar doce sueltas: casi todos los adjetivos de SENTIMIENTO negativo llevan «of» o «about» (afraid of, scared of, worried about, nervous about), y casi todos los de HABILIDAD llevan «at» (good at, bad at, terrible at, brilliant at). Con esas dos familias ya aciertas la mitad.",
      },
      {
        t: "table",
        head: ["Familia","Preposición","Ejemplos"],
        rows: [
          ["habilidad","at","good at, bad at, terrible at"],
          ["miedo o preocupación","of / about","afraid of, scared of, worried about"],
          ["relación con alguien","to / with","married to, angry with, similar to"],
          ["origen o causa","for / from","famous for, responsible for, different from"],
          ["contenido","of","full of, proud of, tired of"]
        ],
      },
      {
        t: "p",
        text: "Una que merece nota aparte: «afraid to» SÍ existe, pero significa otra cosa. «I'm afraid OF dogs» es que los perros te dan miedo. «I'm afraid TO ask» es que te da apuro preguntar. Con «of» + sustantivo es el miedo a una cosa; con «to» + verbo es no atreverse a hacer algo.",
      },
      {
        t: "examples",
        items: [
          { en: "I'm not very good at math.", pron: "aim not vé-ri gud at maz", es: "No se me dan muy bien las mates." },
          { en: "She's married to a teacher.", pron: "shis má-rid tu a tíi-cher", es: "Está casada con un profesor." },
          { en: "I'm afraid of flying.", pron: "aim a-fréid ov flái-ing", es: "Me da miedo volar." },
          { en: "He's worried about the exam.", pron: "jis uó-rid a-báut di ig-sám", es: "Está preocupado por el examen." },
          { en: "This is different from that one.", pron: "dis is dí-frent from dat uán", es: "Esto es diferente de aquello." },
          { en: "I'm interested in learning Japanese.", pron: "aim ín-tres-ted in lér-ning ya-pa-níis", es: "Me interesa aprender japonés." }
        ],
      }
    ],
    quiz: [
      { q: "«Se me da bien el inglés» es…", options: ["I'm good in English","I'm good at English","I'm good with English"], answer: 1, why: "La habilidad va con «at»." },
      { q: "«Casado con» es…", options: ["married with","married to","married at"], answer: 1, why: "«Married to», aunque el español diga «con»." },
      { q: "«Me dan miedo los perros» es…", options: ["I'm afraid to dogs","I'm afraid of dogs","I'm afraid for dogs"], answer: 1, why: "Miedo a una cosa: afraid OF." },
      { q: "«Preocupado por» es…", options: ["worried for","worried about","worried of"], answer: 1, why: "«Worried about», nunca «worried for»." },
      { q: "«Diferente a» es…", options: ["different to","different from","different of"], answer: 1, why: "En americano siempre «different from»." },
      { q: "«Responsable de» es…", options: ["responsible of","responsible for","responsible about"], answer: 1, why: "«Responsible for», aunque el español diga «de»." },
      { q: "Detrás de la preposición, si va un verbo, se pone…", options: ["en infinitivo","en -ing","pelado"], answer: 1, why: "«Good at cooking», «interested in learning»." },
      { q: "«Me interesa aprender» es…", options: ["I'm interested to learn","I'm interested in learn","I'm interested in learning"], answer: 2, why: "Tras preposición siempre -ing." },
      { q: "«I'm afraid to ask» significa…", options: ["Me dan miedo las preguntas","Me da apuro preguntar","Tengo miedo del que pregunta"], answer: 1, why: "Con «to» + verbo es no atreverse; con «of» es el miedo a algo." },
      { q: "Los adjetivos de habilidad llevan…", options: ["at","in","for"], answer: 0, why: "good at, bad at, terrible at." },
      { q: "«Enfadado con alguien» es…", options: ["angry to","angry with","angry of"], answer: 1, why: "Con personas: «angry with»." }
    ],
  },

  {
    id: "concordancia",
    title: "everybody IS, people ARE: concordancias raras",
    tag: "Palabras",
    goal: "Acertar el verbo con las palabras que engañan.",
    blocks: [
      {
        t: "p",
        text: "Hay un puñado de palabras muy comunes que llevan el verbo en un número que no esperas. Y no es una lista caprichosa: casi todas engañan porque en español el equivalente va del otro lado. Son pocas y salen constantemente, así que aprenderlas de golpe rinde mucho.",
      },
      {
        t: "table",
        head: ["Palabra","Verbo","Ejemplo","En español"],
        rows: [
          ["people","PLURAL","People are waiting.","La gente está esperando (singular)."],
          ["police","PLURAL","The police are here.","La policía está aquí (singular)."],
          ["news","SINGULAR","The news is good.","Las noticias son buenas (plural)."],
          ["everybody / everyone","SINGULAR","Everybody is here.","Todos están aquí (plural)."],
          ["nobody / no one","SINGULAR","Nobody knows.","Nadie sabe (singular)."],
          ["information","SINGULAR, incontable","The information is useful.","Las informaciones (plural)."]
        ],
      },
      {
        t: "p",
        text: "Las dos que más se fallan son «people» y «everybody», y por motivos opuestos. «People» parece singular porque se traduce por «la gente», pero en inglés ES el plural de «person»: por eso «people are». Y «everybody» parece plural porque significa «todos», pero gramaticalmente es «cada cuerpo», uno a uno: por eso «everybody is».",
      },
      {
        t: "error",
        wrong: "People is waiting. / Everybody are here. / The news are good.",
        right: "People are waiting. / Everybody is here. / The news is good.",
        why: "Los tres salen de traducir el número del español. «Gente» es singular en español y «people» es plural en inglés; «todos» es plural en español y «everybody» es singular en inglés.",
      },
      {
        t: "tip",
        text: "Truco para «everybody», «somebody», «nobody» y «anybody»: fíjate en que todas acaban en «-body», que es «cuerpo», en singular. Un cuerpo, un verbo en singular. Everybody IS, somebody IS, nobody KNOWS. Con esa imagen ya no se falla.",
      },
      {
        t: "p",
        text: "Y ojo con los incontables, que son la otra fuente de fallos. «Information», «advice», «furniture», «luggage» y «money» no tienen plural en inglés, así que siempre llevan verbo singular y nunca -s. Para contarlos hay que rodearlos: «a piece of advice», «two pieces of information».",
      },
      {
        t: "table",
        head: ["Incontable","Correcto","Nunca","En español"],
        rows: [
          ["information","The information is useful.","informations, are","La información es útil."],
          ["advice","Her advice was good.","advices, were","Su consejo fue bueno."],
          ["furniture","The furniture is new.","furnitures, are","Los muebles son nuevos."],
          ["luggage","My luggage is heavy.","luggages, are","Mi equipaje pesa mucho."],
          ["money","The money is on the table.","monies, are","El dinero está en la mesa."]
        ],
      },
      {
        t: "p",
        text: "Un caso más, y muy útil en la vida real: las cantidades de tiempo, dinero y distancia van en SINGULAR cuando se ven como un bloque. «Two hours is a long time», «Twenty euros is too much», «Five miles is far». Aunque el número sea plural, lo estás tratando como una sola cantidad.",
      },
      {
        t: "examples",
        items: [
          { en: "People are waiting outside.", pron: "píi-pol ar uéi-ting aut-sáid", es: "La gente está esperando fuera." },
          { en: "Everybody is here already.", pron: "év-ri-bo-di is jier ol-ré-di", es: "Todos están ya aquí." },
          { en: "The news is very good today.", pron: "de niús is vé-ri gud tu-déi", es: "Las noticias son muy buenas hoy." },
          { en: "The police are looking for him.", pron: "de po-líis ar lú-king for jim", es: "La policía lo está buscando." },
          { en: "This information is very useful.", pron: "dis in-for-méi-shon is vé-ri iús-ful", es: "Esta información es muy útil." },
          { en: "Two hours is a long time.", pron: "tuu áu-ers is a long táim", es: "Dos horas es mucho tiempo." }
        ],
      }
    ],
    quiz: [
      { q: "«La gente está esperando» es…", options: ["People is waiting","People are waiting","The people is waiting"], answer: 1, why: "«People» es el plural de «person»: verbo en plural." },
      { q: "«Todos están aquí» es…", options: ["Everybody are here","Everybody is here","Everybody were here"], answer: 1, why: "«Everybody» es singular en inglés, aunque signifique «todos»." },
      { q: "¿Por qué «everybody is»?", options: ["Porque es una excepción sin lógica","Porque «-body» es «cuerpo», en singular","Porque siempre se usa «is»"], answer: 1, why: "Un cuerpo, un verbo en singular." },
      { q: "«Las noticias son buenas» es…", options: ["The news are good","The news is good","The new is good"], answer: 1, why: "«News» es singular en inglés pese a acabar en -s." },
      { q: "«La policía está aquí» es…", options: ["The police is here","The police are here","The polices are here"], answer: 1, why: "«Police» va siempre en plural." },
      { q: "«Un consejo» es…", options: ["an advice","a piece of advice","one advice"], answer: 1, why: "«Advice» es incontable: se cuenta con «a piece of»." },
      { q: "«Nadie sabe» es…", options: ["Nobody know","Nobody knows","Nobody are knowing"], answer: 1, why: "Nobody es singular: lleva la -s de tercera persona." },
      { q: "¿Cuál NO tiene plural en inglés?", options: ["idea","information","problem"], answer: 1, why: "Information, advice, furniture y luggage son incontables." },
      { q: "«Dos horas es mucho tiempo» es…", options: ["Two hours are a long time","Two hours is a long time","Two hour is a long time"], answer: 1, why: "Las cantidades vistas como un bloque van en singular." },
      { q: "«Mi equipaje es pesado» es…", options: ["My luggages are heavy","My luggage is heavy","My luggage are heavy"], answer: 1, why: "«Luggage» es incontable y singular." },
      { q: "El problema de fondo con estas palabras es…", options: ["que son irregulares","que el español las trata con el número contrario","que se pronuncian raro"], answer: 1, why: "Gente (sing.) → people (pl.); todos (pl.) → everybody (sing.)." }
    ],
  },

  {
    id: "familia-how",
    title: "La familia de «how»: how long, how often, how far",
    tag: "Palabras",
    goal: "Preguntar cuánto, cuántas veces y a qué distancia.",
    blocks: [
      {
        t: "p",
        text: "«How» solo significa «cómo» cuando va suelto. En cuanto le pegas un adjetivo o un cuantificador detrás, se convierte en otra pregunta completamente distinta. Es una de las construcciones más rentables del inglés: con una sola palabra y lo que le pongas detrás, cubres media docena de preguntas del español.",
      },
      {
        t: "table",
        head: ["Pregunta","Español","Ejemplo"],
        rows: [
          ["how","cómo","How are you?"],
          ["how much","cuánto (incontable, precio)","How much is it?"],
          ["how many","cuántos (contable)","How many people came?"],
          ["how long","cuánto tiempo","How long does it take?"],
          ["how often","con qué frecuencia","How often do you go?"],
          ["how far","a qué distancia","How far is the station?"],
          ["how old","qué edad","How old are you?"],
          ["how tall","cuánto mide (personas)","How tall is he?"]
        ],
      },
      {
        t: "p",
        text: "Fíjate en el mecanismo, porque es lo que te deja fabricar las que no están en la tabla: HOW + adjetivo pregunta por la medida de ese adjetivo. «How deep» es «qué profundidad», «how wide» es «qué anchura», «how heavy» es «cuánto pesa». Si conoces el adjetivo, ya sabes hacer la pregunta.",
      },
      {
        t: "table",
        head: ["Adjetivo","Pregunta","Español"],
        rows: [
          ["old","How old…?","¿Qué edad…?"],
          ["tall","How tall…?","¿Cuánto mide…?"],
          ["deep","How deep…?","¿Qué profundidad…?"],
          ["wide","How wide…?","¿Qué anchura…?"],
          ["heavy","How heavy…?","¿Cuánto pesa…?"],
          ["soon","How soon…?","¿Dentro de cuánto…?"]
        ],
      },
      {
        t: "error",
        wrong: "How many time do you need? / How much people came? / What age are you?",
        right: "How much time do you need? / How many people came? / How old are you?",
        why: "«Time» aquí es incontable, así que va «how much». «People» se cuenta, así que va «how many». Y para la edad el inglés no pregunta por «age»: usa «how old».",
      },
      {
        t: "tip",
        text: "Truco para no confundir «how much» y «how many»: si en español puedes ponerle un número delante sin más («tres personas», «cinco coches»), es MANY. Si necesitas una medida («tres litros de agua», «dos horas de tiempo»), es MUCH. Contables → many. Incontables → much.",
      },
      {
        t: "p",
        text: "Cuidado con dos parejas que se parecen mucho y no preguntan lo mismo. «How long» pregunta por la DURACIÓN («¿cuánto tiempo?»), pero también por la longitud de un objeto. Y «how far» pregunta por la DISTANCIA, no por el tiempo: si respondes «two hours», estás contestando a «how long», no a «how far».",
      },
      {
        t: "table",
        head: ["Pregunta","Pide","Respuesta típica"],
        rows: [
          ["How long is the movie?","duración","Two hours."],
          ["How far is the beach?","distancia","About five kilometers."],
          ["How often do you go?","frecuencia","Twice a week."],
          ["How much is it?","precio","Ten euros."]
        ],
      },
      {
        t: "examples",
        items: [
          { en: "How much is this?", pron: "jáu mach is dis", es: "¿Cuánto cuesta esto?" },
          { en: "How many people are coming?", pron: "jáu mé-ni píi-pol ar ká-ming", es: "¿Cuánta gente viene?" },
          { en: "How long does it take?", pron: "jáu long das it téik", es: "¿Cuánto se tarda?" },
          { en: "How often do you go to the gym?", pron: "jáu ó-fen du yu góu tu de yim", es: "¿Con qué frecuencia vas al gimnasio?" },
          { en: "How far is the station from here?", pron: "jáu far is de stéi-shon from jier", es: "¿A qué distancia está la estación de aquí?" },
          { en: "How old is your brother?", pron: "jáu óuld is yur brá-der", es: "¿Cuántos años tiene tu hermano?" }
        ],
      }
    ],
    quiz: [
      { q: "«¿Cuánto tiempo se tarda?» es…", options: ["How many time does it take?","How long does it take?","How far does it take?"], answer: 1, why: "La duración se pregunta con «how long»." },
      { q: "«¿Cuánta gente vino?» es…", options: ["How much people came?","How many people came?","How long people came?"], answer: 1, why: "«People» se cuenta: how many." },
      { q: "«¿Cuánto cuesta?» es…", options: ["How many is it?","How much is it?","How long is it?"], answer: 1, why: "El precio va con «how much»." },
      { q: "El truco para elegir much o many es…", options: ["mirar si es formal","si puedes ponerle un número delante, es many","usar siempre much"], answer: 1, why: "Contables → many; incontables → much." },
      { q: "«¿Con qué frecuencia?» es…", options: ["How long?","How often?","How much?"], answer: 1, why: "«How often» pregunta por la frecuencia." },
      { q: "«¿A qué distancia está?» es…", options: ["How long is it?","How far is it?","How much is it?"], answer: 1, why: "«How far» es distancia; «how long» es duración." },
      { q: "«¿Cuántos años tienes?» es…", options: ["What age are you?","How many years do you have?","How old are you?"], answer: 2, why: "El inglés pregunta con «how old», no por «age»." },
      { q: "«How + adjetivo» pregunta por…", options: ["la causa","la medida de ese adjetivo","la manera"], answer: 1, why: "How deep, how wide, how heavy: la medida." },
      { q: "«¿Qué profundidad tiene?» es…", options: ["How deep is it?","How much deep is it?","What deep is it?"], answer: 0, why: "How + adjetivo, sin nada en medio." },
      { q: "Si la respuesta es «two hours», la pregunta era…", options: ["How far?","How long?","How many?"], answer: 1, why: "Dos horas es duración, no distancia." },
      { q: "«¿Cuánto tiempo necesitas?» es…", options: ["How many time do you need?","How much time do you need?","How long time do you need?"], answer: 1, why: "«Time» es incontable aquí: how much." }
    ],
  },

  {
    id: "oraciones-tiempo",
    title: "when, while, until: hablar del futuro en presente",
    tag: "Estructuras",
    goal: "Dejar de poner «will» después de «when» y «as soon as».",
    blocks: [
      {
        t: "p",
        text: "Hay una regla que parece absurda al principio y que es de las que más marcan si alguien domina el inglés: después de «when», «if», «as soon as», «until», «before» y «after», NUNCA se pone «will», aunque estés hablando claramente del futuro. Va presente.",
      },
      {
        t: "formula",
        parts: ["when / if / as soon as","PRESENTE","…","will"],
        example: "When I arrive, I will call you.",
      },
      {
        t: "table",
        head: ["Español","Inglés","Dónde va el futuro"],
        rows: [
          ["Cuando llegue, te llamaré.","When I arrive, I will call you.","solo en la segunda mitad"],
          ["En cuanto termine, te aviso.","As soon as I finish, I'll tell you.","solo en la segunda mitad"],
          ["Espera hasta que vuelva.","Wait until I come back.","ninguna lleva will"],
          ["Antes de que te vayas, dime algo.","Before you leave, tell me something.","ninguna lleva will"]
        ],
      },
      {
        t: "error",
        wrong: "When I will arrive, I will call you. / As soon as I will finish…",
        right: "When I arrive, I will call you. / As soon as I finish…",
        why: "El «will» solo puede aparecer una vez, y va en la mitad que dice qué VA A PASAR, no en la que dice cuándo. La mitad del «when» va siempre en presente.",
      },
      {
        t: "p",
      ...
      {
        t: "table",
        head: ["Español","Qué forma usa","Inglés","Qué forma usa"],
        rows: [
          ["Cuando llegue…","subjuntivo","When I arrive…","presente simple"],
          ["En cuanto termine…","subjuntivo","As soon as I finish…","presente simple"],
          ["Hasta que vuelva…","subjuntivo","Until I come back…","presente simple"],
          ["Si llueve…","presente","If it rains…","presente simple"]
        ],
      },
      {
        t: "tip",
        text: "Truco para cazarlo al vuelo: si en español te sale un subjuntivo detrás de «cuando», «en cuanto» o «hasta que», en inglés va PRESENTE SIMPLE. Y una comprobación rápida: en una frase de este tipo solo puede haber UN «will», y va en la mitad que no lleva «when». Si te salen dos, sobra uno.",
      },
      {
        t: "p",
        text: "Aparte de eso, conviene separar bien «when» de «while», que en español caen los dos en «cuando» o «mientras». WHILE va con acciones largas, que duran, y muy a menudo con un continuo. WHEN va con acciones puntuales. Y «until» marca el límite: hasta ese momento.",
      },
      {
        t: "table",
        head: ["Palabra","Se usa con","Ejemplo"],
        rows: [
          ["when","un momento puntual","When the movie ended, we left."],
          ["while","algo que dura, o dos cosas a la vez","While I was cooking, he called."],
          ["until","el límite de algo","I'll wait until you arrive."],
          ["as soon as","inmediatamente después","Call me as soon as you land."],
          ["by the time","para cuando","By the time we arrived, it was over."]
        ],
      },
      {
        t: "examples",
        items: [
          { en: "When I arrive, I'll call you.", pron: "uén ai a-ráiv, ail kol yu", es: "Cuando llegue, te llamaré." },
          { en: "Call me as soon as you land.", pron: "kol mi as suun as yu land", es: "Llámame en cuanto aterrices." },
          { en: "I'll wait until you come back.", pron: "ail uéit an-tíl yu kam bak", es: "Esperaré hasta que vuelvas." },
          { en: "While I was cooking, he called.", pron: "uáil ai uós kú-king, ji kold", es: "Mientras cocinaba, él llamó." },
          { en: "Before you leave, tell me something.", pron: "bi-fór yu liiv, tel mi sám-zing", es: "Antes de que te vayas, dime algo." },
          { en: "By the time we arrived, it was over.", pron: "bai de táim ui a-ráivd, it uós óu-ver", es: "Para cuando llegamos, ya había terminado." }
        ],
      }
    ],
    quiz: [
      { q: "«Cuando llegue, te llamaré» es…", options: ["When I will arrive, I will call you","When I arrive, I will call you","When I arrive, I call you"], answer: 1, why: "Detrás de «when» va presente; el will va en la otra mitad." },
      { q: "Detrás de «as soon as» va…", options: ["will + verbo","presente simple","el verbo pelado"], answer: 1, why: "Nunca «will» después de as soon as." },
      { q: "¿Cuántos «will» caben en «cuando llegue, te llamaré»?", options: ["Dos","Uno","Ninguno"], answer: 1, why: "Solo en la mitad que dice qué va a pasar." },
      { q: "¿Por qué a un español le sale «when I will arrive»?", options: ["Porque el inglés lo permitía antes","Porque en español ahí va subjuntivo y lo sustituimos por futuro","Porque suena más educado"], answer: 1, why: "«Cuando llegue» es subjuntivo, y buscamos algo que suene a futuro." },
      { q: "El subjuntivo español detrás de «cuando» se traduce por…", options: ["will + verbo","presente simple","would + verbo"], answer: 1, why: "«Cuando llegue» = «when I arrive»." },
      { q: "«Esperaré hasta que vuelvas» es…", options: ["I'll wait until you will come back","I'll wait until you come back","I'll wait until you came back"], answer: 1, why: "«Until» también prohíbe el will." },
      { q: "«While» se usa con…", options: ["acciones puntuales","algo que dura o dos cosas a la vez","el futuro"], answer: 1, why: "«While I was cooking…»" },
      { q: "«When» se usa con…", options: ["un momento puntual","algo muy largo","solo el pasado"], answer: 0, why: "«When the movie ended, we left»." },
      { q: "«Llámame en cuanto aterrices» es…", options: ["Call me as soon as you will land","Call me as soon as you land","Call me as soon as you landed"], answer: 1, why: "Presente detrás de as soon as." },
      { q: "«By the time» significa…", options: ["a tiempo","para cuando","en el momento"], answer: 1, why: "«By the time we arrived» = para cuando llegamos." },
      { q: "La comprobación rápida es…", options: ["contar los verbos","que solo haya un «will», y no en la mitad del «when»","buscar comas"], answer: 1, why: "Si te salen dos «will», sobra uno." }
    ],
  },

  {
    id: "verbo-be",
    title: "El verbo «be» entero: am, is, are, was, were",
    tag: "Base",
    goal: "Tener todas las formas del verbo más importante en la cabeza.",
    blocks: [
      {
        t: "p",
        text: "«Be» es el verbo más usado del inglés y el único que conserva una conjugación de verdad: donde los demás tienen dos formas en presente, este tiene tres. Vale la pena tenerlo entero de una vez, porque aparece en todas partes — solo, en los tiempos continuos y en la pasiva.",
      },
      {
        t: "table",
        head: ["Persona","Presente","Pasado","Contracción"],
        rows: [
          ["I","am","was","I'm / I was"],
          ["you","are","were","you're / you were"],
          ["he / she / it","is","was","he's / he was"],
          ["we","are","were","we're / we were"],
          ["they","are","were","they're / they were"]
        ],
      },
      {
        t: "p",
        text: "Las otras dos formas que hacen falta son «been» (el participio, para los tiempos perfectos) y «being» (el -ing). Con esas cinco piezas —am/is/are, was/were, been, being y el propio «be»— ya tienes todo lo que este verbo puede hacer.",
      },
      {
        t: "table",
        head: ["Forma","Se usa en","Ejemplo"],
        rows: [
          ["be","infinitivo, tras modal","I want to be there. / It will be easy."],
          ["am / is / are","presente","She is here."],
          ["was / were","pasado","They were late."],
          ["been","tiempos perfectos","I have been busy."],
          ["being","continuo y pasiva","He is being difficult."]
        ],
      },
      {
        t: "p",
      ...
      {
        t: "table",
        head: ["","Con «be»","Con cualquier otro verbo"],
        rows: [
          ["Afirmativa","I am tired.","I work here."],
          ["Negativa","I am not tired.","I don't work here."],
          ["Pregunta","Are you tired?","Do you work here?"],
          ["Pasado negativo","I wasn't tired.","I didn't work here."],
          ["Pasado pregunta","Were you tired?","Did you work here?"]
        ],
      },
      {
        t: "error",
        wrong: "I don't am tired. / Do you are ready? / She no is here.",
        right: "I'm not tired. / Are you ready? / She isn't here.",
        why: "«Be» nunca lleva «do». Se niega con «not» detrás y se pregunta adelantándolo. Meterle «do» es el error que más delata que se está traduciendo del español.",
      },
      {
        t: "tip",
      ...
      {
        t: "table",
        head: ["Respuestas cortas","Afirmativa","Negativa"],
        rows: [
      ...
      {
        t: "p",
        text: "Una regla de escritura que sorprende: en las respuestas cortas AFIRMATIVAS no se contrae nunca. Se dice «Yes, I am», no «Yes, I'm». La contracción necesita algo detrás donde apoyarse, y si la frase termina ahí, la palabra recupera su forma larga. En las negativas sí se contrae: «No, I'm not».",
      },
      {
        t: "examples",
        items: [
          { en: "I'm not ready yet.", pron: "aim not ré-di yet", es: "Todavía no estoy listo." },
          { en: "Are you from Spain?", pron: "ar yu from spéin", es: "¿Eres de España?" },
          { en: "She wasn't at home.", pron: "shi uó-sent at jóum", es: "No estaba en casa." },
          { en: "They were very tired.", pron: "déi uér vé-ri tái-erd", es: "Estaban muy cansados." },
          { en: "I have been here before.", pron: "ai jav bin jier bi-fór", es: "He estado aquí antes." },
          { en: "It will be easy, don't worry.", pron: "it uil bi íi-si, dóunt uó-ri", es: "Será fácil, no te preocupes." }
        ],
      }
    ],
    quiz: [
      ...
      { q: "Respuesta corta a «Are you ready?»", options: ["Yes, I'm.","Yes, I am.","Yes, I do."], answer: 1, why: "En afirmativas cortas no se contrae nunca." },
      { q: "«No estaba en casa» es…", options: ["She didn't was at home","She wasn't at home","She don't was at home"], answer: 1, why: "El pasado de «be» tampoco lleva «did»." },
      { q: "El truco para saber si hace falta «do» es…", options: ["mirar si la frase es larga","ver si ya hay am/is/are/was/were","contar los sujetos"], answer: 1, why: "Si ya hay una forma de «be», esa es el auxiliar." },
      { q: "«Será fácil» es…", options: ["It will is easy","It will be easy","It will been easy"], answer: 1, why: "Detrás de un modal va el infinitivo pelado: be." }
    ],
  },

  {
    id: "verbos-cambian-significado",
    title: "stop, remember, try: cuando el -ing cambia el sentido",
    tag: "Verbos",
    goal: "Distinguir «dejar de fumar» de «parar para fumar».",
    blocks: [
      {
        t: "p",
        text: "Ya sabes que unos verbos piden -ing y otros piden «to». Hay un grupo pequeño que admite los DOS, pero no como sinónimos: cambian el significado de la frase por completo. Son cinco, salen mucho, y confundirlos puede hacerte decir lo contrario de lo que quieres.",
      },
      {
        t: "table",
        head: ["Verbo","Con -ing","Con to"],
        rows: [
          ["stop","dejar de hacerlo","parar PARA hacer otra cosa"],
          ["remember","acordarse de algo ya hecho","acordarse de hacerlo (antes)"],
          ["forget","olvidar algo ya hecho","olvidarse de hacerlo"],
          ["try","probar a ver qué pasa","intentar (con esfuerzo)"],
          ["regret","lamentar haberlo hecho","lamentar tener que decirlo"]
        ],
      },
      {
        t: "p",
        text: "El patrón que ordena todo el grupo: el -ING mira hacia ATRÁS (algo que ya pasó o que ya estabas haciendo) y el TO mira hacia DELANTE (algo que viene después). Si te quedas con esa imagen, no hace falta memorizar los cinco por separado.",
      },
      {
        t: "table",
        head: ["Frase","Significa","Hacia dónde mira"],
        rows: [
          ["I stopped smoking.","Dejé de fumar.","atrás: fumaba y lo dejé"],
          ["I stopped to smoke.","Paré para fumar.","delante: paré y luego fumé"],
          ["I remember locking the door.","Me acuerdo de haberla cerrado.","atrás: ya la cerré"],
          ["I remembered to lock the door.","Me acordé de cerrarla.","delante: me acordé y la cerré"],
          ["I forgot telling you.","Olvidé que te lo había dicho.","atrás"],
          ["I forgot to tell you.","Se me olvidó decírtelo.","delante: no llegué a decirlo"]
        ],
      },
      {
        t: "error",
        wrong: "I stopped to smoke two years ago. (queriendo decir que lo dejó)",
        right: "I stopped smoking two years ago.",
        why: "«Stopped to smoke» significa que paraste lo que hacías para echarte un cigarro. Si lo que quieres decir es que lo dejaste, va el -ing.",
      },
      {
        t: "tip",
        text: "Truco visual: imagina una flecha. El -ING apunta hacia atrás, a lo que ya estaba pasando. El TO apunta hacia delante, a lo que viene ahora. «Stop smoking» = paras algo que venía de antes. «Stop to smoke» = paras y lo siguiente es fumar. Con «remember» y «forget» funciona idéntico.",
      },
      {
        t: "p",
        text: "«Try» es el que más se falla porque la diferencia es más sutil. «Try TO do» es intentarlo poniendo esfuerzo, sin saber si saldrá. «Try DOING» es probar algo a ver si funciona, como quien prueba un remedio. «Try to open the window» es que la ventana está dura; «try opening the window» es una sugerencia por si hace calor.",
      },
      {
        t: "table",
        head: ["Frase","Significa"],
        rows: [
          ["Try to call her.","Inténtalo (aunque cueste)."],
          ["Try calling her.","Prueba a llamarla, a ver si así se soluciona."],
          ["I tried to move it.","Hice fuerza, con esfuerzo."],
          ["I tried moving it.","Probé a moverlo, a ver qué pasaba."]
        ],
      },
      {
        t: "p",
        text: "Y una advertencia útil: «regret to» aparece casi solo en fórmulas de carta o de anuncio, del tipo «We regret to inform you…» («lamentamos comunicarle…»). En conversación normal lo que se usa es «regret + -ing»: «I regret saying that» (me arrepiento de haber dicho eso).",
      },
      {
        t: "examples",
        items: [
          { en: "I stopped smoking two years ago.", pron: "ai stopt smóu-king tuu yiers a-góu", es: "Dejé de fumar hace dos años." },
          { en: "We stopped to have a coffee.", pron: "ui stopt tu jav a kó-fi", es: "Paramos a tomar un café." },
          { en: "Remember to lock the door.", pron: "ri-mém-ber tu lok de dor", es: "Acuérdate de cerrar la puerta." },
          { en: "I remember locking the door.", pron: "ai ri-mém-ber ló-king de dor", es: "Me acuerdo de haber cerrado la puerta." },
          { en: "I forgot to tell you.", pron: "ai for-gót tu tel yu", es: "Se me olvidó decírtelo." },
          { en: "Try calling her again.", pron: "trái kó-ling jer a-guén", es: "Prueba a llamarla otra vez." }
        ],
      }
    ],
    quiz: [
      { q: "«Dejé de fumar» es…", options: ["I stopped to smoke","I stopped smoking","I stopped smoke"], answer: 1, why: "El -ing mira atrás: fumabas y lo dejaste." },
      { q: "«Paramos a tomar un café» es…", options: ["We stopped having a coffee","We stopped to have a coffee","We stopped have a coffee"], answer: 1, why: "«To» mira hacia delante: paras y luego tomas café." },
      { q: "El patrón que ordena todo el grupo es…", options: ["-ing es formal y to informal","-ing mira atrás, to mira hacia delante","-ing es pasado y to es futuro"], answer: 1, why: "Con esa imagen no hace falta memorizar cada verbo." },
      { q: "«Acuérdate de cerrar la puerta» es…", options: ["Remember locking the door","Remember to lock the door","Remember lock the door"], answer: 1, why: "Todavía no lo has hecho: mira hacia delante." },
      { q: "«Me acuerdo de haberla cerrado» es…", options: ["I remember to lock it","I remember locking it","I remembered lock it"], answer: 1, why: "Ya está hecho: el -ing mira atrás." },
      { q: "«Se me olvidó decírtelo» es…", options: ["I forgot telling you","I forgot to tell you","I forgot tell you"], answer: 1, why: "No llegaste a decirlo: to." },
      { q: "«I forgot telling you» significa…", options: ["Olvidé decírtelo","Olvidé que ya te lo había dicho","No quise decírtelo"], answer: 1, why: "El -ing indica que la acción ya había ocurrido." },
      { q: "«Prueba a llamarla, a ver si así se arregla» es…", options: ["Try to call her","Try calling her","Try call her"], answer: 1, why: "«Try + -ing» es probar algo como solución." },
      { q: "«Try to open it» sugiere que…", options: ["es una sugerencia sin más","está duro y hay que hacer esfuerzo","ya está abierto"], answer: 1, why: "«Try to» implica esfuerzo o dificultad." },
      { q: "«Regret to inform you» aparece sobre todo en…", options: ["conversación normal","cartas y anuncios formales","preguntas"], answer: 1, why: "En el día a día se usa «regret + -ing»." },
      { q: "«Me arrepiento de haber dicho eso» es…", options: ["I regret to say that","I regret saying that","I regret say that"], answer: 1, why: "Mira hacia atrás: -ing." }
    ],
  },
];
